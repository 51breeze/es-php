 ...
 * @return array
 */
declare function spl_classes(): array
 ...
 * @since 5.1.2
 */
declare function spl_autoload(className:string,file_extensions?:string): void
 ...
 * @since 5.1.2
 */
declare function spl_autoload_register(callback:(...args)=>void,throwFlag:boolean = true,prepend:boolean = false):boolean
 ...
 * @since 5.1.2
 */
declare function spl_autoload_unregister(callback:(...args)=>void):boolean
 ...
 * @since 5.1.2
 */
declare function spl_autoload_functions()
 ...
 * @since 5.1.2
 */
declare function spl_autoload_call(className:string): void
 ...
 */
declare function class_parents(object_or_class:any,autoload:boolean = true): array|false
 ...
 * @return string[]|false An array on success, or false on error.
 */
declare function class_implements(object_or_class:any,autoload:boolean = true): array|false
 ...
 * the same object.
 */
declare function spl_object_hash(object:object): string
 ...
 */
declare function iterator_to_array(iterator:Traversable,preserve_keys:boolean = true): array
 ...
 */
declare function iterator_count(iterator:Traversable): int
 ...
 */
declare function iterator_apply(iterator:Traversable,callback:(...args)=>void,args?:array): int
// End of SPL v.0.2
 ...
 * @since 5.4
 */
declare function class_uses(object_or_class:any,autoload:boolean = true): array|false
 ...
 * @since 7.2
 */
declare function spl_object_id(object:object): int
