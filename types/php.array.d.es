 ...
 */
declare function syslog(priority:int,  message:string):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function closelog():boolean;
 ...
 * @param callback:(...args)=>voidFunction called just before the headers are sent.
 * @return bool true on success or false on failure.
 */
declare function header_register_callback(callback:(...args)=>void):boolean
 ...
 * @since 5.4
 */
declare function getimagesizefromstring(string:string , image_info:RMD<any>): array|false
 ...
 * @since 5.4
 */
declare function stream_set_chunk_size(stream:Resource,  size:int):int|false;
 ...
 * @removed 5.4
 */
declare function define_syslog_variables() 
 ...
 */
declare function lcg_value(): float
 ...
 */
declare function metaphone(string:string,  max_phonemes:int = 0): false|string


/**
 * Turn on output buffering
 * @link https://php.net/manual/en/function.ob-start.php
 * @param callback (...args)=>void [optional] <p>
 ...
 * @return bool true on success or false on failure.
 */
declare function ob_start(callback:(...args)=>void,  chunk_size?:int,  flags?:int):boolean
 ...
 * @return bool
 */
declare function ob_flush():boolean 
 ...
 * @return bool
 */
declare function ob_clean():boolean 
 ...
 */
declare function ob_end_flush():boolean
 ...
 * not be deleted (possible for special buffer).
 */
declare function ob_end_clean():boolean
 ...
 */
declare function ob_get_flush(): string|false
 ...
 */
declare function ob_get_clean(): string|false
 ...
 * buffering is active.
 */
declare function ob_get_length(): int|false
 ...
 */
declare function ob_get_level(): int
 ...
 * </table>
 */
declare function ob_get_status(full_status:boolean = false): array
 ...
 */
declare function ob_get_contents(): string|false
 ...
 * @return void
 */
declare function ob_implicit_flush(enable = true): void 
 ...
 * handler".
 */
declare function ob_list_handlers(): array
 ...
 * @return bool true on success or false on failure.
 */
declare function ksort(array:RMD<array>,  flags:int):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function krsort(array:RMD<array>,  flags:int):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function natsort(array:RMD<array>):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function natcasesort(array:RMD<array>):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function asort(array:RMD<array>,  flags:int):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function arsort(array:RMD<array>,  flags:int):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function sort(array:RMD<array>,  flags:int):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function rsort(array:RMD<array>,  flags:int):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function usort(array:RMD<array>,  callback:(...args)=>void):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function uasort(array:RMD<array>,  callback:(...args)=>void):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function uksort(array:RMD<array>,  callback:(...args)=>void):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function shuffle(array:RMD<array>):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function array_walk(array:RMD<object|array>,  callback:(...args)=>void,  arg:any):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function array_walk_recursive(array:RMD<object|array>,  callback:(...args)=>void,  arg:any):boolean
 ...
 * </p>
 */
declare function count(value:Countable|array,  mode?:int): int
 ...
 * @meta
 */
declare function end(array:RMD<object|array>):any 
 ...
 * @meta
 */
declare function prev(array:RMD<object|array>):any 
 ...
 * @meta
 */
declare function next(array:RMD<object|array>):any 
 ...
 * @meta
 */
declare function reset(array:RMD<object|array>):any 
 ...
 * @meta
 */
declare function current(array:object|array):any 
 ...
 */
declare function key(array:object|array): string|int|null
 ...
 * @param ...values [optional] any comparable value
 * @return mixed min returns the numerically lowest of the
 * parameter values.
 */
declare function min(value:any, ...values):any
 ...
 */
declare function max(value:any, ...values):any
 ...
 * false otherwise.
 */
declare function in_array(needle, haystack:any[], strict:boolean = false): boolean
 ...
 */
declare function array_search (needle:any, haystack:any[], strict:boolean = false): string|int|false
 ...
 * table.
 */
declare function extract<T extends array>(array:RMD<T>, flags:int, prefix:string): int
 ...
 */
declare function compact (var_name:string, ...var_names): array
 ...
 */
declare function array_fill(start_index:int, count:int, value:any): array
 ...
 * @return array the filled array
 */
declare function array_fill_keys(keys:string|number[], value:any ): array
...
declare function range (start:number, end:number, step:int|float = 1): array
 ...
 * @return bool true on success or false on failure.
 */
declare function array_multisort<T extends array>(array:RMD<T>, ...rest:RMD<any>[] ): boolean
 ...
 */
declare function array_push<T extends array>(array:RMD<T>, ...values): int
 ...
 * @meta
 */
declare function array_pop<T extends array>(array:RMD<T>): any;
 ...
 * @meta
 */
declare function array_shift<T extends array>(array:RMD<T>):any
 ...
 * @return int the number of elements in the array.
 */
declare function array_unshift<T extends array>(array:RMD<T>, ...$values): int
 ...
 */
declare function array_splice<T extends array>(array:RMD<T>, offset:int, length?:int, ...replacement:any[] ): any[]
 ...
 * @meta
 */
declare function array_slice<T extends array>(array:T, offset:int, length?:int,preserve_keys?:boolean ): T[]
 ...
 */
declare function array_merge<T extends array>(...arrays:T[]): T[]
 ...
 * @link https://php.net/manual/en/array.constants.php
 */
type SORT_LOCALE_STRING = 5;

declare function array_unique<T extends array>(array:T, flags:SORT_REGULAR | SORT_NUMERIC | SORT_STRING |  SORT_DESC | SORT_ASC | SORT_LOCALE_STRING ): array
 ...
 * @meta
 */
declare function array_intersect<T extends array>(array:T, array:array, ...items:array[]): T[];
 ...
 * @meta
 */
declare function array_intersect_key<T extends array>(array:T, array:array, ...items:array[]):(string|number)[];
 ...
 * @meta
 */
declare function array_intersect_ukey<T extends array>(array:T, items:array, compare?:(a,b)=>number ): T[];
 ...
 * @meta
 */
declare function array_uintersect<T extends array>(array:T, items:array[], compare?:(a,b)=>number): T[];
 ...
 * @meta
 */
declare function array_intersect_assoc<T extends array>(array:T, ...items:array[]):T[]
 ...
 * @meta
 */
declare function array_uintersect_assoc<T extends array>(array:T, items:array[], compare:(a,b)=>number):T[]
 ...
 * @meta
 */
declare function array_intersect_uassoc<T extends array>(array:T, items:array[],compare:(a,b)=>number):T[]
 ...
 * @meta
 */
declare function array_uintersect_uassoc<T extends array>(array:T, items:array[],compare:(a,b)=>number):T[]
 ...
 * @meta
 */
declare function array_diff<T extends array>(array:T, ...items:array[]):T[]
 ...
 * @meta
 */
declare function array_diff_key<T extends array>(array:T, ...items:array[]): T[]
 ...
 * @meta
 */
declare function array_diff_ukey<T extends array>(array:T, items:array[],compare:(a,b)=>number):T[]
 ...
 * @meta
 */
declare function array_udiff<T extends array>(array:T, items:array[],compare:(a,b)=>number):T[]
 ...
 * @meta
 */
declare function array_diff_assoc<T extends array>(array:T, ...items:array[]):T[]
 ...
 * @meta
 */
declare function array_udiff_assoc<T extends array>(array:T, items:array[],compare:(a,b)=>number):T[]
 ...
 * @meta
 */
declare function array_diff_uassoc<T extends array>(array:T, items:array[],compare:(a,b)=>number):T[]
 ...
 * @meta
 */
declare function array_udiff_uassoc<T extends array>(array:T, items:array[],compareValue:(a,b)=>number, compareKey:(a,b)=>number):T[]
 ...
 */
declare function array_sum(array:any[]): number
 ...
 */
declare function array_product(array:any[]): number
 ...
 * @meta
 */
declare function array_filter<T extends array>(array:T, callback?:(a)=>boolean, mode?:number):T[]
 ...
 * @meta
 */
declare function array_map<T=any>(callback:(a:T)=>T, ...items:array[]):T[]
 ...
 */
declare function array_chunk<T=any>(array:T[], length:number, preserve_keys?:boolean): T[];
 ...
 * @meta
 */
declare function array_combine<T=any>(keys:(number|string)[], values:T[]):T[]