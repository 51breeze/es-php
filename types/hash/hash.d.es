 ...
 */
declare function hash(algo:string,data:string,binary:boolean = false): string|false
 ...
 * @since 5.6
 */
declare function hash_equals(known_string:string,user_string:string):boolean
 ...
 * binary representation of the message digest is returned.
 */
declare function hash_file(algo:string,filename:string,binary:boolean = false): string|false
 ...
 * binary representation of the message digest is returned.
 */
declare function hash_hmac(algo:string,data:string,key:string,binary:boolean = false): string|false
 ...
 * binary representation of the message digest is returned.
 */
declare function hash_hmac_file(algo:string,data:string,key:string,binary:boolean = false): string|false
 ...
 * and <b>hash_final</b>.
 */
declare function hash_init(algo:string,flags?:int = 0,key?:string)
 ...
 */
declare function hash_update(context:any,data:string):boolean
 ...
 */
declare function hash_update_stream(context:any,stream:any,length:int = -1): int
 ...
 */
declare function hash_update_file(context:any,filename:string,stream_context:any):boolean
 ...
 * binary representation of the message digest is returned.
 */
declare function hash_final(context:any,binary:boolean = false): string
 ...
 */
declare function hash_copy(context:any)
 ...
 * hashing algorithms.
 */
declare function hash_algos(): array
 ...
 */
declare function hash_hkdf(algo:string ,key:string,length:int = 0,info:string = '',salt:string = ''):string|false
 ...
 */
declare function hash_hmac_algos(): array
 ...
 * @since 5.5
 */
declare function hash_pbkdf2(algo:string,password:string,salt:string,iterations:int,length:int = 0,binary:boolean = false): string
 ...
 */
declare function mhash_keygen_s2k(algo:int,password:string,salt:string,length:int): string|false
 ...
 * does not exist.
 */
declare function mhash_get_block_size(algo:int): int|false
 ...
 */
declare function mhash_get_hash_name(algo:int): string|false
 ...
 * hash ID.
 */
declare function mhash_count(): int
 ...
 * <b>FALSE</b> on error.
 */
declare function mhash(algo:int,data:string,key?:string): string|false
 ...
 */
declare const HASH_HMAC= 1;
declare const MHASH_CRC32= 0;
/**
 * @since 7.4
 */
declare const MHASH_CRC32C= 34;
declare const MHASH_MD5= 1;
declare const MHASH_SHA1= 2;
declare const MHASH_HAVAL256= 3;
declare const MHASH_RIPEMD160= 5;
declare const MHASH_TIGER= 7;
declare const MHASH_GOST= 8;
declare const MHASH_CRC32B= 9;
declare const MHASH_HAVAL224= 10;
declare const MHASH_HAVAL192= 11;
declare const MHASH_HAVAL160= 12;
declare const MHASH_HAVAL128= 13;
declare const MHASH_TIGER128= 14;
declare const MHASH_TIGER160= 15;
declare const MHASH_MD4= 16;
declare const MHASH_SHA256= 17;
declare const MHASH_ADLER32= 18;
declare const MHASH_SHA224= 19;
declare const MHASH_SHA512= 20;
declare const MHASH_SHA384= 21;
declare const MHASH_WHIRLPOOL= 22;
declare const MHASH_RIPEMD128= 23;
declare const MHASH_RIPEMD256= 24;
declare const MHASH_RIPEMD320= 25;
declare const MHASH_SNEFRU256= 27;
declare const MHASH_MD2= 28;
declare const MHASH_FNV132= 29;
declare const MHASH_FNV1A32= 30;
declare const MHASH_FNV164= 31;
declare const MHASH_FNV1A64= 32;
declare const MHASH_JOAAT= 33;

declare class HashContext{
    public __serialize()
    /**
     * @param array $data
     */
    public __unserialize(data:any)
}
// End of hash v.1.0
