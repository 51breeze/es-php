...
declare class Redis
{
     ...
     * </pre>
     */
    connect(host:any,port:any = 6379,timeout:any = 0.0,reserved:any = null,retryInterval:any = 0,readTimeout:any = 0.0)
    /**
     * Connects to a Redis instance.
     *
     * @param string $host          can be a host, or the path to a unix domain socket
     ...
     * @return bool TRUE on success, FALSE on error
     */
    open(host:any,port:any = 6379,timeout:any = 0.0,reserved:any = null,retryInterval:any = 0,readTimeout:any = 0.0)
    /**
     ...
     *
     * @return int|boolean Returns the database number (int) phpredis thinks it's pointing to
     ...
     *
     * @return float|boolean Returns the read timeout (which can be set using setOption and Redis::OPT_READ_TIMEOUT)
     * or FALSE if we're not connected
     */
    getReadTimeout()
    /**
     ...
     *
     * @return string|null|boolean Returns the persistent id phpredis is using
     ...
     *
     * @return string|null|boolean Returns the password used to authenticate a phpredis session or NULL if none was used,
     * and FALSE if we're not connected
     */
    getAuth()
    /**
     ...
     * </pre>
     */
    pconnect(host:any,port:any = 6379,timeout:any = 0.0,persistentId:any = null,retryInterval:any = 0,readTimeout:any = 0.0
    )
    /**
     * @param string $host
     * @param int    $port
     ...
     * @return bool
     */
        popen(host:any,port:any = 6379,timeout:any = 0.0,persistentId:any = '',retryInterval:any = 0,readTimeout:any = 0.0
    )
    /**
     ...
     * @return int Number of keys deleted
     */
        delete(key1:any,key2:any = null,key3:any = null)
    /**
     ...
     * </pre>
     */
    unlink(key1:any,key2:any = null,key3:any = null)
    /**
     ...
     * @example
     * <pre>
     * function f(redis:any,chan:any,msg:any) {
     *  switch(chan:any) {
     *      case 'chan-1':
     *          ...
     *          break;
     ...
     * @example
     * <pre>
     * function psubscribe(redis:any,pattern:any,chan:any,msg:any) {
     ...
     * </pre>
     */
    pubsub(keyword:any,argument:any)
    /**
     ...
     */
    punsubscribe(patterns:any = null)
    /**
     ...
     *
     * @return int|boolean The number of keys tested that do exist
     *
     ...
     * var_dump(redis:any->lRange('l', 0, -1) );
     * // Output:
     * // array(4) {
     * //   [0]=> string(2) "v4"
     * //   [1]=> string(2) "v3"
     ...
     * @param   string $key
     *
     * @return  mixed|boolean if command executed successfully BOOL FALSE in case of failure (empty list)
     *
     ...
     * @param string $key
     *
     * @return int|boolean The size of the list identified by Key exists.
     ...
     * @param int    $index
     *
     * @return mixed|boolean the element at this index
     *
     ...
     * @return array
     */
        lGetRange(key:any,start:any,end:any)
    /**
     ...
     * @param int       $stop
     */
        listTrim(key:any,start:any,stop:any)
    /**
     ...
     * @param int    $count
     *
     * @return int|boolean the number of elements to remove
     ...
     * @param int $count
     */
        lRemove(key:any,value:any,count:any)
    /**
     ...
     *
     * @return int|boolean The number of elements added to the set.
     ...
     * @example
     * <pre>
     * var_dump(redis:any->sAdd('k', 'v1', 'v2', 'v3') );    // int(3)
     * var_dump(redis:any->sRem('k', 'v2', 'v3') );          // int(2)
     * var_dump(redis:any->sMembers('k') );
     * //// Output:
     * // array(1) {
     * //   [0]=> string(2) "v1"
     * // }
     ...
     *
     * @return string|mixed|array|boolean "popped" values
     ...
     * var_dump(redis:any->sPop('key2', 3) ); // Will return all members but in no particular order
     *
     * // array(3) {
     * //   [0]=> string(4) "set2"
     * //   [1]=> string(4) "set3"
     ...
     * @param int    $count [optional]
     *
     * @return string|mixed|array|boolean value(s) from the set
     ...
     *
     * var_dump(redis:any->sRandMember('key1') );     // 'key1' => {'one', 'two', 'three'}
     *
     * // string(5) "three"
     *
     * var_dump(redis:any->sRandMember('key1', 2) );  // 'key1' => {'one', 'two', 'three'}
     *
     * // array(2) {
     * //   [0]=> string(2) "one"
     * //   [1]=> string(5) "three"
     ...
     * </pre>
     */
    sRandMember(key:any,count:any = 1)
    /**
     ...
     *
     * var_dump(redis:any->sInter('key1', 'key2', 'key3'));
     *
     * //array(2) {
     * //  [0]=>
     * //  string(4) "val4"
     ...
     * $redis->sAdd('key3', 'val4');
     *
     * var_dump(redis:any->sInterStore('output', 'key1', 'key2', 'key3'));
     * var_dump(redis:any->sMembers('output'));
     *
     * //int(2)
     * //
     * //array(2) {
     ...
     * </pre>
     */
    sInterStore(dstKey:any,key1:any, ...otherKeys:any[])
    /**
     ...
     * $redis->sAdd('s2', '4');
     *
     * var_dump(redis:any->sUnion('s0', 's1', 's2'));
     *
     * array(4) {
     * //  [0]=>
     * //  string(1) "3"
     ...
     * $redis->sAdd('s2', '4');
     *
     * var_dump(redis:any->sUnionStore('dst', 's0', 's1', 's2'));
     * var_dump(redis:any->sMembers('dst'));
     *
     * //int(4)
     * //array(4) {
     * //  [0]=>
     ...
     * </pre>
     */
    sUnionStore(dstKey:any,key1:any, ...otherKeys:any[])
    /**
     ...
     * $redis->sAdd('s2', '3');
     *
     * var_dump(redis:any->sDiff('s0', 's1', 's2'));
     *
     * //array(2) {
     * //  [0]=>
     * //  string(1) "4"
     ...
     * $redis->sAdd('s2', '3');
     *
     * var_dump(redis:any->sDiffStore('dst', 's0', 's1', 's2'));
     * var_dump(redis:any->sMembers('dst'));
     *
     * //int(2)
     * //array(2) {
     ...
     * </pre>
     */
    sDiffStore(dstKey:any,key1:any, ...otherKeys:any[])
    /**
     ...
     * <pre>
     * $iterator = null;
     * while (members:any = $redis->sScan('set',iterator:any)) {
     ...
     * <pre>
     * $key = $redis->randomKey();
     * $surprise = $redis->get(key:any);  // who knows what's in there.
     * </pre>
     */
    randomKey()
    /**
     ...
     * @param   string  $dstKey
     */
        renameKey(srcKey:any,dstKey:any)
    /**
     * Renames a key
     *
     ...
     * $redis->expireAt('x',now:any + 3); // x will disappear in 3 seconds.
     * sleep(5);                        // wait 5 seconds
     * $redis->get('x');                // will return `FALSE`, as 'x' has expired.
     * </pre>
     */
     ...
     * </pre>
     */
    slaveof(host:any = '127.0.0.1',port:any = 6379)
    /**
     ...
     */
    slowLog(operation:string,length:int = null)
    /**
     ...
     */
    wait(numSlaves:any,timeout:any)
    /**
     ...
     * @param   int     $end
     */
        substr(key:any,start:any,end:any)
    /**
     ...
     * var_dump(redis:any->bitCount('bit', 0, 0) ); // int(4)
     * var_dump(redis:any->bitCount('bit', 1, 1) ); // int(3)
     * var_dump(redis:any->bitCount('bit', 2, 2) ); // int(4)
     * var_dump(redis:any->bitCount('bit', 0, 2) ); // int(11)
     * </pre>
     */
    bitCount(key:any)
    /**
     ...
     * </pre>
     */
    bitOp(operation:any,retKey:any,key1:any, ...otherKeys:any[])
    /**
     ...
     * $redis->sadd('s', 3);
     *
     * var_dump(redis:any->sort('s')); // 1,2,3,4,5
     * var_dump(redis:any->sort('s', array('sort' => 'desc'))); // 5,4,3,2,1
     * var_dump(redis:any->sort('s', array('sort' => 'desc', 'store' => 'out'))); // (int)5
     * </pre>
     */
     ...
     * @param string $key
     *
     * @return int|boolean the time left to live in seconds
     *
     ...
     * @param string $key
     *
     * @return int|boolean the time left to live in milliseconds
     *
     ...
     * var_dump(redis:any->get('key0'));
     * var_dump(redis:any->get('key1'));
     * // Output:
     * // string(6) "value0"
     * // string(6) "value1"
     * </pre>
     ...
     * var_dump(redis:any->mget(array('x', 'y', 'z', 'h')));
     * // Output:
     * // array(3) {
     * //   [0]=> string(1) "a"
     * //   [1]=> string(1) "b"
     ...
     * var_dump(redis:any->rpoplpush('x', 'y'));
     * var_dump(redis:any->lRange('x', 0, -1));
     * var_dump(redis:any->lRange('y', 0, -1));
     *
     * //Output:
     * //
     * //string(3) "abc"
     ...
     * @param int    $timeout
     *
     * @return  string|mixed|boolean  The element that was moved in case of success, FALSE in case of timeout
     *
     ...
     *
     * var_dump(redis:any->zRange('z', 0, -1) );
     * // Output:
     * // array(4) {
     * //   [0]=> string(2) "v1"
     * //   [1]=> string(2) "v4"
     ...
     * // }
     *
     * var_dump(redis:any->zRange('z', 0, -1, true) );
     * // Output:
     * // array(4) {
     * //   ["v1"]=> float(1)
     * //   ["v4"]=> float(4)
     ...
     * </pre>
     */
    zAdd(key:any,options:any,score1:any,value1:any = null,score2:any = null,value2:any = null,scoreN:any = null,valueN:any = null)
    /**
     ...
     * </pre>
     */
    zRem(key:any,member1:any, ...otherMembers:any[])
    /**
     * @link https://redis.io/commands/zrem
     *
     * @param string       $key
     ...
     * @return int Number of deleted values
     */
        zDelete(key:any,member1:any, ...otherMembers:any[])
    /**
     ...
     * @param float  $end
     */
        zDeleteRangeByScore(key:any,start:any,end:any)
    /**
     ...
     * @param int    $end
     */
        zDeleteRangeByRank(key:any,start:any,end:any)
    /**
     ...
     * @param string|mixed $member
     *
     * @return float|boolean false if member or key not exists
     *
     ...
     */
        zUnion(Output:any,ZSetKeys:any,Weights:array = null,aggregateFunction:any = 'SUM')
    /**
     ...
     * @param string $aggregateFunction
     */
        zInter(Output:any,ZSetKeys:any,Weights:array = null,aggregateFunction:any = 'SUM')
    /**
     ...
     * </pre>
     */
    bzPopMax(key1:any,key2:any,timeout:any)
    /**
     * @param string|array $key1
     * @param string|array $key2 ...
     * @param int $timeout
     ...
     */
    bzPopMin(key1:any,key2:any,timeout:any)
    /**
     ...
     *
     * @return int|boolean Number of deleted fields
     *
     ...
     *               ));
     *
     * var_dump(redis:any->hDel('h', 'f1') );        // int(1)
     * var_dump(redis:any->hDel('h', 'f2', 'f3') );  // int(2)
     * s
     * var_dump(redis:any->hGetAll('h') );
     * //// Output:
     * //  array(1) {
     * //    ["f4"]=> string(2) "v4"
     * //  }
     * </pre>
     */
    hDel(key:any,hashKey1:any, ...otherHashKeys:any[])
    /**
     ...
     * $redis->hset('h', 'int',   3);
     * var_dump(redis:any->hIncrByFloat('h', 'float', 1.5) ); // float(4.5)
     *
     * var_dump(redis:any->hGetAll('h') );
     *
     * // Output
     ...
     * <pre>
     * // $iterator = null;
     * // while(elements:any = $redis->hscan('hash',iterator:any)) {
     ...
     * $redis->del("myplaces");
     *
     * // Since the key will be new,result:any will be 2
     * $result = $redis->geoAdd(
     *   "myplaces",
     ...
     * </pre>
     */
    geodist(key:any,member1:any,member2:any,unit:any = null)
    /**
     ...
     * var_dump(redis:any->geoRadius("hawaii", -157.858, 21.306, 300, 'mi'));
     *
     * echo "\nWithin 300 miles of Honolulu with distances:\n";
     * $options = ['WITHDIST'];
     * var_dump(redis:any->geoRadius("hawaii", -157.858, 21.306, 300, 'mi',options:any));
     *
     ...
     * </pre>
     */
    georadius(key:any,longitude:any,latitude:any,radius:any,unit:any,options:array = null)
    /**
     ...
     *
     * echo "Within 300 miles of Honolulu:\n";
     * var_dump(redis:any->geoRadiusByMember("hawaii", "Honolulu", 300, 'mi'));
     *
     * echo "\nFirst match within 300 miles of Honolulu:\n";
     * var_dump(redis:any->geoRadiusByMember("hawaii", "Honolulu", 300, 'mi', ['count' => 1]));
     *
     * // Output
     * Within 300 miles of Honolulu:
     * array(2) {
     ...
     * </pre>
     */
    georadiusbymember(key:any,member:any,radius:any,units:any,options:array = null)
    /**
     ...
     * </pre>
     */
    config(operation:any,key:any,value:any)
    /**
     ...
     * </pre>
     */
    eval(script:any,args:any = array(),numKeys:any = 0)
    /**
     * @param   string  $script
     * @param   array   $args
     * @param   int     $numKeys
     ...
     */
        evaluate(script:any,args:any = array(),numKeys:any = 0)
    /**
     ...
     * <pre>
     * $script = 'return 1';
     * $sha = $redis->script('load',script:any);
     * $redis->evalSha(sha:any); // Returns 1
     * </pre>
     */
     ...
     * @param int    $numKeys
     */
        evaluateSha(scriptSha:any,args:any = array(),numKeys:any = 0)
    /**
     ...
     * @example
     * <pre>
     * $redis->script('load',script:any);
     * $redis->script('flush');
     * $redis->script('kill');
     * $redis->script('exists',script1:any, [$script2,script3:any, ...]);
     * </pre>
     *
     ...
     * $redis->set('foo', 'bar');
     * $val = $redis->dump('foo');
     * $redis->restore('bar', 0,val:any); // The key 'bar', will now be equal to the key 'foo'
     * </pre>
     */
     ...
     * </pre>
     */
    migrate(host:any,port:any,key:any,db:any,timeout:any,copy:any = false,replace:any = false)
    /**
     ...
     * <pre>
     * $iterator = null;
     * while(false !== (keys:any = $redis->scan(iterator:any))) {
     ...
     * </pre>
     */
    scan(iterator:RMD<any>,pattern:any = null,count:any = 0)
    /**
     ...
     * </pre>
     */
    rawCommand(command:any,args:any)
    /**
     ...
     * </pre>
     */
    xAck(stream:any,group:any,messages:any)
    /**
     ...
     * </pre>
     */
    xAdd(key:any,id:any,messages:any,maxLen:any = 0,isApproximate:any = false)
    /**
     ...
     *
     * // Without any options
     * $redis->xClaim('mystream', 'group1', 'myconsumer1', 0,ids:any);
     *
     * // With options
     * $redis->xClaim(
     *     'mystream', 'group1', 'myconsumer2', 0,ids:any,
     *     [
     *         'IDLE' => time() * 1000,
     *         'RETRYCOUNT' => 5,
     *         'FORCE',
     ...
     * </pre>
     */
    xClaim(key:any,group:any,consumer:any,minIdleTime:any,ids:any,options:any = [])
    /**
     ...
     * </pre>
     */
    xGroup(operation:any,key:any,group:any,msgId:any = '',mkStream:any = false)
    /**
     ...
     * </pre>
     */
    xInfo(operation:any,stream:any,group:any)
    /**
     ...
     * </pre>
     */
    xPending(stream:any,group:any,start:any = null,end:any = null,count:any = null,consumer:any = null)
    /**
     ...
     * </pre>
     */
    xRange(stream:any,start:any,end:any,count:any = null)
    /**
     ...
     * </pre>
     */
    xRead(streams:any,count:any = null,block:any = null)
    /**
     ...
     * </pre>
     */
    xReadGroup(group:any,consumer:any,streams:any,count:any = null,block:any = null)
    /**
     ...
     * </pre>
     */
    xRevRange(stream:any,end:any,start:any,count:any = null)
    /**
     ...
     * </pre>
     */
    xTrim(stream:any,maxLen:any,isApproximate:any)
    /**
     * Adds a values to the set value stored at key.
     *
     * @param string $key Required key
     ...
     * </pre>
     */
    sAddArray(key:any,values:array)
}

declare class RedisException extends Exception{}

/**
 * @mixin \Redis
 */
declare class RedisArray
{
    /**
     * Constructor
     *
     ...
     */
    __construct(hosts:any,opts?:array = null)
    /**
