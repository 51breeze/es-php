 ...
 */
declare function iconv(from_encoding:string,to_encoding:string,string:string): string|false
 ...
 * return values.
 */
declare function ob_iconv_handler(contents:string,status:int): string
 ...
 * </p>
 */
declare function iconv_get_encoding(type:string = "all"): array|string|false
 ...
 */
declare function iconv_set_encoding(type:string,encoding:string):boolean
 ...
 */
declare function iconv_strlen(string:string,encoding?:string = 'ini_get("iconv.internal_encoding")'): int|false
 ...
 * </p>
 */
declare function iconv_substr(string:string,offset:int,length?:int,encoding?:string = 'ini_get("iconv.internal_encoding")'): string|false
 ...
 * </p>
 */
declare function iconv_strpos(haystack:string,needle:string,offset:int = 0,encoding?:string = 'ini_get("iconv.internal_encoding")'): int|false
 ...
 * </p>
 */
declare function iconv_strrpos(haystack:string,needle:string,encoding?:string = 'ini_get("iconv.internal_encoding")'): int|false
 ...
 */
declare function iconv_mime_encode(field_name:string,field_value:string,options:array): string|false
 ...
 */
declare function iconv_mime_decode(string:string,mode:int = 0,encoding?:string = 'ini_get("iconv.internal_encoding")'): string|false
 ...
 * </p>
 */
declare function iconv_mime_decode_headers(headers:string,mode:int = 0,encoding?:string = 'ini_get("iconv.internal_encoding")'): array|false

/**
 * string
 * @link https://php.net/manual/en/iconv.constants.php
 */
declare const ICONV_IMPL= "unknown";

/**
 * string
 * @link https://php.net/manual/en/iconv.constants.php
 */
declare const ICONV_VERSION= 2.17;

/**
 * integer
 * @link https://php.net/manual/en/iconv.constants.php
 */
declare const ICONV_MIME_DECODE_STRICT= 1;

/**
 * integer
 * @link https://php.net/manual/en/iconv.constants.php
 */
declare const ICONV_MIME_DECODE_CONTINUE_ON_ERROR= 2;
// End of iconv v.
