 ...
 */
declare function strtolower(string:string): string
 ...
 * </p>
 */
declare function strpos(haystack:string,needle:string,offset:int = 0): int|false
 ...
 */
declare function stripos(haystack:string,needle:string,offset:int): int|false
 ...
 * </p>
 */
declare function strrpos(haystack:string,needle:string,offset:int = 0): int|false
 ...
 */
declare function strripos(haystack:string,needle:string,offset:int): int|false
 ...
 */
declare function hebrev(string:string,max_chars_per_line:int): string
 ...
 * @removed 8.0
 */
declare function hebrevc(hebrew_text:string,max_chars_per_line:any): string
 ...
 */
declare function nl2br(string:string,use_xhtml:boolean = true): string
 ...
 * /component removed.
 */
declare function dirname(path:string,levels?:int): string
 ...
 * backslash (\).
 */
declare function stripslashes(string:string): string
 ...
 */
declare function stripcslashes(string:string): string
 ...
 * is not found.
 */
declare function strstr(haystack:string,needle:string,before_needle:boolean = false): string|false
 ...
 * found, returns false.
 */
declare function stristr(haystack:string,needle:string,before_needle:boolean = false): string|false
 ...
 * </p>
 */
declare function strrchr(haystack:string,needle:string): string|false
 ...
 */
declare function str_shuffle(string:string): string
 ...
 * format chosen.
 */
declare function str_word_count(string:string,format:int = 0, characters:string=null): array|int
 ...
 * </p>
 */
declare function str_split(string:string,length:int = 1): array|false
 ...
 * not found.
 */
declare function strpbrk(string:string,characters:string): string|false
 ...
 * false.
 */
declare function substr_compare(haystack:string,needle:string,offset:int,length?:int,case_insensitive:boolean = false): int
 ...
 */
declare function strcoll(string1:string,string2:string): int
 ...
 * @see NumberFormatter
 */
declare function money_format(format:string,number:float):string|null
 ...
 */
declare function substr(string:string,offset:int,length?:int)
 ...
 */
declare function substr_replace(string:array|string,replace:array|string,offset:array|int,length:array|int|null = null): array|string
 ...
 */
declare function quotemeta(string:string): string
 ...
 */
declare function ucwords(string:string,separators:string = " \t\r\n\f\v"): string
 ...
 * to.
 */
declare function strtr(string:string,from:string,to:string): string
 ...
 */
declare function strtr(str:string,replace_pairs:array): string
 ...
 */
declare function addslashes(string:string): string
 ...
 * @return string the escaped string.
 */
declare function addcslashes(string:string,characters:string): string
 ...
 * @return string the modified string.
 */
declare function rtrim(string:string,characters:string = " \t\n\r\0\x0B"): string
 ...
 */
declare function str_replace(search:array|string,replace:array|string,subject:array|string,count:RMD<any>): array|string
 ...
 */
declare function str_ireplace(search:array|string,replace:array|string,subject:array|string,count:RMD<any>): array|string
 ...
 */
declare function str_repeat(string:string,times:int): string
 ...
 */
declare function count_chars(string:string,mode:int): array|string
 ...
 */
declare function chunk_split(string:string,length:int = 76,separator:string = "\r\n"): string
 ...
 */
declare function trim(string:string,characters:string = " \t\n\r\0\x0B"): string
 ...
 * (0x0B)), a vertical tab.
 */
declare function ltrim(string:string,characters:string = " \t\n\r\0\x0B"): string
 ...
 */
declare function strip_tags(string:string,allowed_tags:any = null): string
 ...
 */
declare function similar_text(string1:string,string2:string,percent:RMD<any>): int
 ...
 */
declare function explode(separator:string,string:string,limit:int): array|false
 ...
 */
declare function implode(separator?:array|string,array?:array): string
 ...
 * elements in the same order, with the glue string between each element.
 */
declare function join(separator?:array|string,array?:array): string
 ...
 */
declare function setlocale(category:int,locales:array|string|int, ...rest:any[]): string|false
 ...
 */
declare function localeconv(): array
