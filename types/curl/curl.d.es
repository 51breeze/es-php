declare class CURLFile {
     ...
     * @since 5.5
     */
    constructor(filename:any,mime_type:any = '',posted_filename:any = '')
     ...
     * @since 5.5
     */
    setMimeType(mime_type:any):string
    /**
     ...
     * @since 5.5
     */
    setPostFilename(posted_filename:any):string
    /**
 ...
 */
declare function curl_init(url?:string):Resource|false|CurlHandle
 ...
 */
declare function curl_copy_handle(handle:any):CurlHandle|Resource|false;
 ...
 * </tr>
 */
declare function curl_version(age:any = null): array|false
 ...
 */
declare function curl_setopt(handle:any,option:int,value:any):boolean
 ...
 * @since 5.1.3
 */
declare function curl_setopt_array(handle:any,options:array):boolean
 ...
 * @since 5.5
 */
declare function curl_share_close(share_handle:any): void
 ...
 * @since 5.5
 */
declare function curl_share_init():Resource|CurlShareHandle
 ...
 * @since 5.5
 */
declare function curl_share_setopt(share_handle:CurlShareHandle|Resource,option:int,value:string):boolean
 ...
 * @since 5.5
 */
declare function curl_strerror(error_code:int):string|null
 ...
 * @since 5.5
 */
declare function curl_unescape(handle:CurlHandle|Resource,string:string): string|false
/**
 * Perform a cURL session
 * @link https://php.net/manual/en/function.curl-exec.php
 * @param CurlHandle|resource $handle
 * @return string|boolean true on success or false on failure. However, if the CURLOPT_RETURNTRANSFER
 * option is set, it will return the result on success, false on failure.
 */
declare function curl_exec(handle:CurlHandle|Resource): string|boolean
 ...
 * "redirect_time"
 */
declare function curl_getinfo(handle:CurlHandle|Resource,option?:int):any
 ...
 * error occurred.
 */
declare function curl_error(handle:CurlHandle|Resource): string
 ...
 * occurred.
 */
declare function curl_errno(handle:CurlHandle|Resource): int
 ...
 * @since 5.5
 */
declare function curl_escape(handle:CurlHandle|Resource,string:string): string|false
 ...
 * @since 5.5
 */
declare function curl_file_create(filename:string,mime_type?:string = '',posted_filename?:string = ''): CURLFile
 ...
 * @return void
 */
declare function curl_close(handle:CurlHandle|Resource): void
 ...
 */
declare function curl_multi_init(): CurlMultiHandle|Resource|false
 ...
 * code.
 */
declare function curl_multi_add_handle(multi_handle:CurlMultiHandle|Resource,handle:CurlHandle|Resource): int
 ...
 */
declare function curl_multi_remove_handle(multi_handle:CurlMultiHandle|Resource,handle:CurlHandle|Resource):int|false
 ...
 */
declare function curl_multi_select(multi_handle:CurlMultiHandle|Resource,timeout:float = 1.0): int
 ...
 * @since 5.5
 */
declare function curl_multi_setopt(multi_handle:CurlMultiHandle|Resource,option:int,value:any):boolean
 ...
 * @since 5.5
 */
declare function curl_multi_strerror(error_code:int):string|null
 ...
 * @since 5.5
 */
declare function curl_pause(handle:CurlHandle|Resource,flags:int): int
 ...
 * @since 5.5
 */
declare function curl_reset(handle:CurlHandle|Resource): void
 ...
 * </p>
 */
declare function curl_multi_exec(multi_handle:CurlMultiHandle|Resource,still_running:RMD<number>): int
 ...
 */
declare function curl_multi_getcontent(handle:CurlHandle|Resource):string|null
 ...
 */
declare function curl_multi_info_read(multi_handle:CurlMultiHandle|Resource,queued_messages:RMD<number>): array|false
 ...
 * @return void
 */
declare function curl_multi_close(multi_handle:CurlMultiHandle|Resource): void
 ...
 * @since 7.1
 */
declare function curl_multi_errno(multi_handle:CurlMultiHandle|Resource): int
 ...
 * @since 7.1
 */
declare function curl_share_errno(share_handle:CurlMultiHandle|Resource): int
 ...
 * @since 7.1
 */
declare function curl_share_strerror(error_code:int):string|null

/**
 * @since 8.0
 */
declare final class CurlHandle{}

/**
 * @since 8.0
 */
declare final class CurlMultiHandle{}

/**
 * @since 8.0
 */
declare final class CurlShareHandle{}
