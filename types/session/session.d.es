 ...
 */
declare function session_name(name?:string): string|false
 ...
 */
declare function session_module_name(module?:string): string|false
 ...
 */
declare function session_save_path(path?:string): string|false
 ...
 */
declare function session_id(id?:string): string|false
 ...
 */
declare function session_regenerate_id(delete_old_session:boolean = false):boolean
 ...
 * @return void
 */
declare function session_register_shutdown(): void
 ...
 * @return bool true on success or false on failure.
 */
declare function session_decode(data:string):boolean
 ...
 * @removed 5.4
 */
declare function session_register(name:any, ..._:any[]):boolean
 ...
 * @removed 5.4
 */
declare function session_unregister(name:string):boolean
 ...
 * @removed 5.4
 */
declare function session_is_registered(name:string):boolean
 ...
 */
declare function session_encode(): string|false
 ...
 * otherwise false.
 */
declare function session_start(options:array = []):boolean
 ...
 * @since 7.1
 */
declare function session_create_id(prefix:string): string|false
 ...
 * @since 7.1
 */
declare function session_gc(): int|false
 ...
 * @return bool true on success or false on failure.
 */
declare function session_destroy():boolean

/**
 * Free all session variables
 * @link https://php.net/manual/en/function.session-unset.php
 * @return void|boolean since 7.2.0 returns true on success or false on failure.
 */
declare function session_unset()
 ...
 * @return bool true on success or false on failure.
 */
declare function session_set_save_handler(open:GeneralCallback,close:GeneralCallback,read:GeneralCallback,write:GeneralCallback,destroy:GeneralCallback,gc:GeneralCallback,create_sid:any,validate_sid:any,update_timestamp:any):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function session_set_save_handler(session_handler:SessionHandlerInterface,register_shutdown:any = true):boolean
 ...
 */
declare function session_cache_limiter(value?:string): string|false
 ...
 */
declare function session_cache_expire(value?:int): int|false
 ...
 * @since 7.3
 */
declare function session_set_cookie_params(options:array):boolean
 ...
 * @return void|boolean since 7.2.0 returns true on success or false on failure.
 */
declare function session_set_cookie_params(lifetime_or_options:array|int,path?:string,domain?:string,secure?:boolean = false,httponly?:boolean = false)
 ...
 */
declare function session_get_cookie_params(): array
 ...
 * @return void|boolean since 7.2.0 returns true on success or false on failure.
 */
declare function session_write_close()
 ...
 * @return void|boolean since 7.2.0 returns true on success or false on failure.
 */
declare function session_commit()
 ...
 * @since 5.4
 */
declare function session_status(): int

/**
 * (PHP 5 >= 5.6.0)<br>
 * Discard session array changes and finish session
 * @link https://php.net/manual/en/function.session-abort.php
 * @return void|boolean since 7.2.0 returns true if a session was successfully reinitialized or false on failure.
 * @since 5.6
 */
declare function session_abort()
 ...
 * @since 5.6
 */
declare function session_reset()
// End of session v.
