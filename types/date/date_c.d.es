 ...
 * @since 5.5
 */
declare interface DateTimeInterface {
    /**
     * @since 7.2
     */
     ...
     *
     */
    diff(targetObject:any,absolute:any = false):DateInterval
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
 ...
 * @since 5.5
 */
declare class DateTimeImmutable implements DateTimeInterface {
    /* Methods */
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     ...
     */
    constructor(datetime?:string,timezone:DateTimeZone = null)
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     ...
     * @return static
     */
    add(interval:DateInterval):this;
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     ...
     */
    static createFromFormat(format:string,datetime:string,timezone:DateTimeZone = null):DateTimeImmutable|false
    /**
     * (PHP 5 &gt;=5.6.0)<br/>
     ...
     */
    static createFromMutable(object:DateTime):DateTimeImmutable
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
    ...
    static getLastErrors():array|false
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     ...
     */
    static __set_state(array:array):DateTimeImmutable;
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * Sets the date
     ...
     *
     */
    setDate(year:int,month:int,day:int):this|false;
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * Sets the ISO date
     ...
     * Returns the {@link https://secure.php.net/manual/en/class.datetimeimmutable.php DateTimeImmutable} object for method chaining or <b>FALSE</b> on failure.
     */
    setISODate(year:int,week:int,dayOfWeek?:int = 1):this|false;
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * Sets the time
     ...
     * Returns the {@link https://secure.php.net/manual/en/class.datetimeimmutable.php DateTimeImmutable} object for method chaining or <b>FALSE</b> on failure.
     */
    setTime(hour:int,minute:int,second?:int = 0,microsecond?:int = 0):this|false;
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     ...
     * Returns the {@link https://secure.php.net/manual/en/class.datetimeimmutable.php DateTimeImmutable} object for method chaining or <b>FALSE</b> on failure.
     */
    setTimestamp(timestamp:number):this|false;
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * Sets the time zone
     ...
     * Returns the {@link https://secure.php.net/manual/en/class.datetimeimmutable.php DateTimeImmutable} object for method chaining or <b>FALSE</b> on failure.
     */
    setTimezone(timezone:DateTimeZone):this|false;
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     ...
     * Returns the {@link https://secure.php.net/manual/en/class.datetimeimmutable.php DateTimeImmutable} object for method chaining or <b>FALSE</b> on failure.
     */
    sub(interval:DateInterval):this|false;
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * Returns the difference between two DateTime objects
     * @link https://secure.php.net/manual/en/datetime.diff.php
     ...
     * difference between the two dates or <b>FALSE</b> on failure.
     */
    diff(targetObject:DateTimeInterface,absolute?:boolean = false):DateInterval
    /**
     * (PHP 5 &gt;=5.5.0)<br/>
     * Returns date formatted according to given format
     * @link https://secure.php.net/manual/en/datetime.format.php
     ...
     * @since 8.0
     */
    static createFromInterface(object:DateTimeInterface):DateTimeImmutable
}
 ...
 */
declare class DateTime implements DateTimeInterface {
    /**
     * @removed 7.2
     */
    const ATOM = 'Y-m-d\TH:i:sP';
     ...
     */
    modify(modifier:string):this|false;
    /**
     ...
     * @return DateTime
     */
    static createFromImmutable(object:DateTimeImmutable):DateTime
    /**
     ...
     */
    sub(interval:DateInterval):this;
    /**
     ...
     */
    setDate (year:int,month:int,day:int):this;
    /**
     ...
     */
    setISODate (year:int,week:int,dayOfWeek:int = 1):this;
    /**
     ...
     */
    diff(targetObject:DateTimeInterface,absolute?:boolean = false):DateInterval|false
    /**
     ...
     */
    static createFromFormat(format:string,datetime:string,timezone:DateTimeZone = null):DateTime|false
    /**
     ...
     * @since 8.0
     */
    static createFromInterface(object:DateTimeInterface):DateTime
}
...
declare class DateTimeZone {
     ...
     */
    getOffset(datetime:DateTimeInterface):int|false
    /**
     ...
     */
    getTransitions (timestampBegin:int=null,timestampEnd:int=null):array|false
    /**
     * Returns associative array containing dst, offset and the timezone name
     * @return array|false
     * @link https://php.net/manual/en/datetimezone.listabbreviations.php
     */
    static listAbbreviations():array|false
    /**
     ...
     */
    static listIdentifiers (timezoneGroup?:int,countryCode?:string = null):array|false
 ...
 */
declare class DatePeriod implements IteratorAggregate {
     ...
     */
    constructor(start:DateTimeInterface,interval:DateInterval,end:DateTimeInterface,options:number = 0)
    /**
     * @param DateTimeInterface $start
     * @param DateInterval $interval
     ...
     * @link https://php.net/manual/en/dateperiod.construct.php
     */
    constructor(start:DateTimeInterface,interval:DateInterval,recurrences:number,options:number = 0)
    /**
     * @param string $isostr String containing the ISO interval.
     * @param int $options Can be set to DatePeriod::EXCLUDE_START_DATE.
     * @link https://php.net/manual/en/dateperiod.construct.php
     */
    constructor(isostr:string,options:number = 0)
