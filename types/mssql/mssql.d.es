 ...
 * @removed 7.0
 */
declare function mssql_connect(servername:any = null,username:any = null,password:any = null,new_link:any = false)
 ...
 * @removed 7.0
 */
declare function mssql_pconnect(servername:any = null,username:any = null,password:any = null,new_link:any = false)
 ...
 * @removed 7.0
 */
declare function mssql_close(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mssql_select_db(database_name:any,link_identifier:any = null)
 ...
 * </p>
 * @return resource|boolean a MS SQL result resource on success, true if no rows were
 * returned, or false on error.
 * @removed 7.0
 */
declare function mssql_query(query:any,link_identifier:any = null,batch_size:any = 0)
 ...
 * @removed 7.0
 */
declare function mssql_fetch_batch(result:any)
 ...
 * @removed 7.0
 */
declare function mssql_rows_affected(link_identifier:any)
 ...
 * @removed 7.0
 */
declare function mssql_free_result(result:any)
 ...
 * @removed 7.0
 */
declare function mssql_get_last_message()
 ...
 * @removed 7.0
 */
declare function mssql_num_rows(result:any)
 ...
 * @removed 7.0
 */
declare function mssql_num_fields(result:any)
 ...
 * @removed 7.0
 */
declare function mssql_fetch_field(result:any,field_offset:any = -1)
 ...
 * @removed 7.0
 */
declare function mssql_fetch_row(result:any)
 ...
 * @removed 7.0
 */
declare function mssql_fetch_array(result:any,result_type:any = MSSQL_BOTH)
 ...
 * @removed 7.0
 */
declare function mssql_fetch_assoc(result_id:any)
 ...
 * @removed 7.0
 */
declare function mssql_fetch_object(result:any)
 ...
 * @removed 7.0
 */
declare function mssql_field_length(result:any,offset:any = null)
 ...
 * @removed 7.0
 */
declare function mssql_field_name(result:any,offset:any = -1)
 ...
 * @removed 7.0
 */
declare function mssql_field_type(result:any,offset:any = -1)
 ...
 * @removed 7.0
 */
declare function mssql_data_seek(result_identifier:any,row_number:any)
 ...
 * @removed 7.0
 */
declare function mssql_field_seek(result:any,field_offset:any)
 ...
 * @removed 7.0
 */
declare function mssql_result(result:any,row:any,field:any)
 ...
 * @removed 7.0
 */
declare function mssql_next_result(result_id:any)
 ...
 * @removed 7.0
 */
declare function mssql_min_error_severity(severity:any)
 ...
 * @removed 7.0
 */
declare function mssql_min_message_severity(severity:any)
 ...
 * @removed 7.0
 */
declare function mssql_init(sp_name:any,link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mssql_bind(stmt:any,param_name:any,vars:RMD<any>,type:any,is_output:any = false,is_null:any = false,maxlen:any = -1)
 ...
 * @removed 7.0
 */
declare function mssql_execute(stmt:any,skip_results:any = false)
 ...
 * @removed 7.0
 */
declare function mssql_free_statement(stmt:any)
 ...
 * @removed 7.0
 */
declare function mssql_guid_string(binary:any,short_format:any = null)
 ...
 * @link https://php.net/manual/en/mssql.constants.php
 */
declare const SQLCHAR= 47;

/**
 * Represents one byte, with a range of -128 to 127.
 * @link https://php.net/manual/en/mssql.constants.php
 */
declare const SQLINT1= 48;
 ...
 * @link https://php.net/manual/en/mssql.constants.php
 */
declare const SQLBIT= 50;

/**
 * Represents an four byte float.
 * @link https://php.net/manual/en/mssql.constants.php
 */
declare const SQLFLT4= 59;

/**
 * Represents an eight byte float.
 * @link https://php.net/manual/en/mssql.constants.php
 */
declare const SQLFLT8= 62;
declare const SQLFLTN= 109;
// End of mssql v.
