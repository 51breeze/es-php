 ...
 * @removed 7.0
 */
declare function mysql_connect(server?:string,username?:string,password?:string,new_link?:boolean = false,client_flags?:number = 0)
 ...
 * @removed 7.0
 */
declare function mysql_pconnect(server?:string,username?:string,password?:string,client_flags?:number = null)
 ...
 * @removed 7.0
 */
declare function mysql_close(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_select_db(database_name:any,link_identifier:any = null)
 ...
 * </p>
 * @param resource $link_identifier [optional]
 * @return resource|boolean For SELECT, SHOW, DESCRIBE, EXPLAIN and other statements returning resultset,
 * <b>mysql_query</b>
 ...
 * @removed 7.0
 */
declare function mysql_query(query:any,link_identifier:any = null)
 ...
 * </p>
 * @param resource $link_identifier [optional]
 * @return resource|boolean For SELECT, SHOW, DESCRIBE or EXPLAIN statements,
 ...
 * @removed 7.0
 */
declare function mysql_unbuffered_query(query:any,link_identifier:any = null)
 ...
 * </p>
 * @param resource $link_identifier [optional]
 * @return resource|boolean a positive MySQL result resource to the query result,
 ...
 * @see mysql_query()
 */
declare function mysql_db_query(database:any,query:any,link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_list_dbs(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_list_tables(database:any,link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_list_fields(database_name:any,table_name:any,link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_list_processes(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_error(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_errno(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_affected_rows(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_insert_id(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_result(result:any,row:any,field:any = 0)
 ...
 * @removed 7.0
 */
declare function mysql_num_rows(result:any)
 ...
 * @removed 7.0
 */
declare function mysql_num_fields(result:any)
 ...
 * @removed 7.0
 */
declare function mysql_fetch_row(result:any)
 ...
 * @removed 7.0
 */
declare function mysql_fetch_array(result:any,result_type:any = MYSQL_BOTH)
 ...
 * @removed 7.0
 */
declare function mysql_fetch_assoc(result:any)
 ...
 * @removed 7.0
 */
declare function mysql_fetch_object(result:any,class_name:any = 'stdClass',params:array = null )
 ...
 * @removed 7.0
 */
declare function mysql_data_seek(result:any,row_number:any)
 ...
 * @removed 7.0
 */
declare function mysql_fetch_lengths(result:any)
 ...
 * @removed 7.0
 */
declare function mysql_fetch_field(result:any,field_offset:any = 0)
 ...
 * @removed 7.0
 */
declare function mysql_field_seek(result:any,field_offset:any)
 ...
 * @removed 7.0
 */
declare function mysql_free_result(result:any)
 ...
 * @removed 7.0
 */
declare function mysql_field_name(result:any,field_offset:any)
 ...
 * @removed 7.0
 */
declare function mysql_field_table(result:any,field_offset:any)
 ...
 * @removed 7.0
 */
declare function mysql_field_len(result:any,field_offset:any)
 ...
 * @removed 7.0
 */
declare function mysql_field_type(result:any,field_offset:any)
 ...
 * @removed 7.0
 */
declare function mysql_field_flags(result:any,field_offset:any)
 ...
 * @removed 7.0
 */
declare function mysql_escape_string(unescaped_string:any)
 ...
 * @removed 7.0
 */
declare function mysql_real_escape_string(unescaped_string:any,link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_stat(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_thread_id(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_client_encoding(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_ping(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_get_client_info()
 ...
 * @removed 7.0
 */
declare function mysql_get_host_info(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_get_proto_info(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_get_server_info(link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_info(link_identifier:any = null)
 ...
 */
declare function mysql_set_charset(charset:any,link_identifier:any = null)
 ...
 * @removed 7.0
 */
declare function mysql(database_name:any,query:any,link_identifier:any)
 ...
 * @removed 7.0
 */
declare function mysql_fieldname(result:any,field_index:any)
 ...
 * @removed 7.0
 */
declare function mysql_fieldtable(result:any,field_offset:any)
 ...
 * @removed 7.0
 */
declare function mysql_fieldlen(result:any,field_offset:any)
 ...
 * @removed 7.0
 */
declare function mysql_fieldtype(result:any,field_offset:any)
 ...
 * @removed 7.0
 */
declare function mysql_fieldflags(result:any,field_offset:any)
 ...
 * @removed 7.0
 */
declare function mysql_selectdb(database_name:any,link_identifier:any)

/**
 * @param $result
 * @removed 7.0
 */
declare function mysql_freeresult(result:any)

/**
 * @param $result
 * @removed 7.0
 */
declare function mysql_numfields(result:any)
 ...
 * @removed 7.0
 */
declare function mysql_numrows(result:any)

/**
 * @param $link_identifier [optional]
 * @removed 7.0
 */
declare function mysql_listdbs(link_identifier:any)
 ...
 * @removed 7.0
 */
declare function mysql_listtables(database_name:any,link_identifier:any)
 ...
 * @removed 7.0
 */
declare function mysql_listfields(database_name:any,table_name:any,link_identifier:any)
 ...
 * @removed 7.0
 */
declare function mysql_db_name(result:any,row:any,field:any = null)
 ...
 * @removed 7.0
 */
declare function mysql_dbname(result:any,row:any,field:any)
 ...
 * @removed 7.0
 */
declare function mysql_tablename(result:any,i:any)
 ...
 * @removed 7.0
 */
declare function mysql_table_name(result:any,row:any,field:any)
 ...
 * @removed 7.0
 */
declare const MYSQL_CLIENT_COMPRESS= 32;
 ...
 * @removed 7.0
 */
declare const MYSQL_CLIENT_SSL= 2048;
 ...
 * @removed 7.0
 */
declare const MYSQL_CLIENT_INTERACTIVE= 1024;
 ...
 * @removed 7.0
 */
declare const MYSQL_CLIENT_IGNORE_SPACE= 256;
// End of mysql v.1.0
