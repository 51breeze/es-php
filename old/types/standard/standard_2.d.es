 ...
 * is not valid.
 */
declare function nl_langinfo(item:int): string|false
 ...
 */
declare function soundex(string:string): string
 ...
 */
declare function levenshtein(string1:string,string2:string,insertion_cost:int = 1,replacement_cost:int = 1,deletion_cost:int = 1): int
 ...
 */
declare function chr(codepoint:int): string
 ...
 */
declare function ord(character:string): int
 ...
 * @return void
 */
declare function parse_str(string:string,result:RMD<any>): void
 ...
 */
declare function str_getcsv(string:string,separator:string = ",",enclosure:string = '"',escape:string = "\\"): array
 ...
 */
declare function str_pad(string:string,length:int,pad_string:string = " ",pad_type:number=STR_PAD_RIGHT): string
 ...
 * @see rtrim()
 */
declare function chop(string:string,characters:string): string
 ...
 * use the faster and less memory intensive declare function strpos() instead.
 *
 ...
 */
declare function strchr(haystack:string,needle:string,before_needle:boolean = false): string|false
 ...
 * format.
 */
declare function sprintf(format:string, ...values:any[]): string
 ...
 */
declare function printf(format:string, ...values:any[]): int
 ...
 * @return int the length of the outputted string.
 */
declare function vprintf(format:string,values:array): int
 ...
 * for sprintf).
 */
declare function vsprintf(format:string,values:array): string
 ...
 */
declare function fprintf(stream:any,format:string, ...values:any[]): int
 ...
 * @return int the length of the outputted string.
 */
declare function vfprintf(stream:any,format:string,values:array): int
 ...
 */
declare function sscanf(string:string,format:string, ...vars:RMD<any>[]): array|int|null
 ...
 * parameters must be passed by reference.
 */
declare function fscanf(stream:any,format:string, ...vars:RMD<any>[]): array|int|false|null
 ...
 */
declare function rawurlencode(string:string): string
 ...
 */
declare function rawurldecode(string:string): string
 ...
 */
declare function http_build_query(data:object|array, numeric_prefix:string = "", arg_separator:string = "&", encoding_type:int = PHP_QUERY_RFC1738): string
 ...
 */
declare function readlink(path:string): string|false
 ...
 */
declare function linkinfo(path:string): int|false
 ...
 */
declare function symlink(target:string,link:string):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function link(target:string ,link:string):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function unlink(filename:string,context:any):boolean
 ...
 * output parameter.
 */
declare function exec(command:string,output:RMD<any>,result_code:RMD<any>): string|false
 ...
 * on failure.
 */
declare function system(command:string,result_code:RMD<any>): string|false
 ...
 * @return bool|null
 */
declare function passthru(command:string,result_code:RMD<any>):boolean|null
 ...
 */
declare function shell_exec(command:string): string|false|null
 ...
 * returns false.
 */
declare function proc_open(command:array|string,descriptor_spec:array,pipes:RMD<any>,cwd?:string,env_vars?:array,options?:array)
 ...
 */
declare function proc_close(process:any): int
 ...
 */
declare function proc_terminate(process:any,signal:int = 15):boolean
 ...
 * </tr>
 */
declare function proc_get_status(process:any)
 ...
 */
declare function proc_nice(priority:int):boolean
 ...
 */
declare function rand(min?:int,max?:int): int
 ...
 * @return void
 */
declare function srand(seed:int,mode:int = MT_RAND_MT19937): void
 ...
 */
declare function getrandmax(): int
 ...
 */
declare function mt_rand(min?:int,max?:int): int
 ...
 * @return void
 */
declare function mt_srand(seed:int,mode:int = MT_RAND_MT19937): void
 ...
 */
declare function mt_getrandmax(): int
 ...
 */
declare function getservbyname(service:string,protocol:string): int|false
 ...
 */
declare function getservbyport(port:int,protocol:string): string|false
 ...
 */
declare function getprotobyname(protocol:string): int|false
 ...
 */
declare function getprotobynumber(protocol:int): string|false
 ...
 */
declare function getmyuid(): int|false
 ...
 */
declare function getmygid(): int|false
 ...
 */
declare function getmypid(): int|false
 ...
 */
declare function getmyinode(): int|false
