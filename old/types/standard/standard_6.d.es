 ...
 */
declare function stream_select(read?:RMD<array>,write?:RMD<array>,except?:RMD<array>,seconds?:int,microseconds?:int): int|false
 ...
 */
declare function stream_context_create(options?:ArrayMapping<array> | ArrayMapping<string>[],params?:array):Resource
 ...
 */
declare function stream_context_set_params(context:any,params:array):boolean
 ...
 */
declare function stream_context_get_params(context:any): array
 ...
 * @return bool true on success or false on failure.
 */
declare function stream_context_set_option(context:any,wrapper_or_options:string,option_name:string,value:any):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function stream_context_set_option(stream_or_context:any,options:array):boolean
 ...
 */
declare function stream_context_get_options(stream_or_context:any): array
 ...
 * @return resource A stream context resource.
 */
declare function stream_context_get_default(options?:array)
 ...
 */
declare function stream_context_set_default(options:array)
 ...
 */
declare function stream_filter_prepend(stream:any,filter_name:string,mode:int,params:any)
 ...
 * instance during a call to stream_filter_remove.
 */
declare function stream_filter_append(stream:any,filter_name:string,mode:int,params:any)
 ...
 * @return bool true on success or false on failure.
 */
declare function stream_filter_remove(stream_filter:any):boolean
 ...
 */
declare function stream_socket_client(address:string,error_code:RMD<any>,error_message:RMD<any>,timeout?:float,flags?:number,context?:Resource)
 ...
 */
declare function stream_socket_server(address:string,error_code:RMD<any>,error_message:RMD<any>,flags?:number,context:Resource=null)
 ...
 */
declare function stream_socket_accept(socket:any,timeout?:float,peer_name?:RMD<any>)
 ...
 */
declare function stream_socket_get_name(socket:any,remote:boolean): string|false
 ...
 */
declare function stream_socket_recvfrom(socket:any,length:int,flags:int,address:RMD<any>): string|false
 ...
 */
declare function stream_socket_sendto(socket:any,data:string,flags:int,address:string): int|false
 ...
 */
declare function stream_socket_enable_crypto(stream:any,enable:boolean,crypto_method?:int,session_stream?:any): int|boolean
 ...
 * @since 5.2.1
 */
declare function stream_socket_shutdown(stream:any,mode:int):boolean
 ...
 * false on failure.
 */
declare function stream_socket_pair(domain:int,type:int,protocol:int): array|false
 ...
 */
declare function stream_copy_to_stream(from:any,to:any,length?:int,offset:int): int|false
 ...
 */
declare function stream_get_contents(stream:any,length:int = -1,offset:int = -1): string|false
 ...
 * @return bool true on success or false on failure.
 */
declare function stream_supports_lock(stream:any):boolean
 ...
 * </p>
 */
declare function fgetcsv(stream:any,length:int = 0,separator:string = ',',enclosure:string = '"',escape:string = '\\'): array|false
 ...
 */
declare function fputcsv(stream:any,fields:array,separator:string = ",",enclosure:string = '"',escape:string = "\\"): int|false
 ...
 * @return bool true on success or false on failure.
 */
declare function flock(stream:any,operation:int,would_block:RMD<any>):boolean
 ...
 * </p>
 */
declare function get_meta_tags(filename:string,use_include_path:boolean = false): array|false
 ...
 */
declare function stream_set_write_buffer(stream:any,size:int): int
 ...
 */
declare function stream_set_read_buffer(stream:any,size:int): int
 ...
 * @return int
 */
declare function set_file_buffer(stream:any,size:int): int
 ...
 * @see stream_set_blocking()
 */
declare function set_socket_blocking(socket:any,mode:boolean):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function stream_set_blocking(stream:any,enable:boolean):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function socket_set_blocking(stream:any,enable:boolean):boolean
 ...
 * </p>
 */
declare function stream_get_meta_data(stream:any): array
 ...
 * </p>
 */
declare function stream_get_line(stream:any,length:int,ending:string): string|false
 ...
 * </p>
 */
declare function stream_wrapper_register(protocol:string,className:string,flags:int):boolean
 ...
 * </p>
 */
declare function stream_register_wrapper(protocol:string,className:string,flags:int = 0):boolean
 ...
 * @since 5.3.2
 */
declare function stream_resolve_include_path(filename:string): string|false
 ...
 * @return bool true on success or false on failure.
 */
declare function stream_wrapper_unregister(protocol:string):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function stream_wrapper_restore(protocol:string):boolean
 ...
 */
declare function stream_get_wrappers(): array
 ...
 */
declare function stream_get_transports(): array
 ...
 * @since 5.2.4
 */
declare function stream_is_local(stream:any):boolean
 ...
 * failure.
 */
declare function get_headers(url:string,associative:boolean = false,context:Resource=null): array|false
 ...
 * @return bool true on success or false on failure.
 */
declare function stream_set_timeout(stream:any,seconds:int,microseconds:int):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function socket_set_timeout(stream:any,seconds:int,microseconds:int = 0):boolean
 ...
 * </p>
 */
declare function socket_get_status(stream:any): array
 ...
 * </p>
 */
declare function realpath(path:string): string|false
 ...
 */
declare function fnmatch(pattern:string,filename:string,flags:int):boolean
