 ...
 * @since 5.5
 */
declare function boolval(value:any):boolean
 ...
 * apply.
 */
declare function intval(value:any,base:int = 10): int
 ...
 */
declare function floatval(value:any): float
 ...
 * @return float value of the given variable. Empty arrays return 0, non-empty arrays return 1.
 */
declare function doubleval(value:any): float
 ...
 */
declare function settype(vars:RMD<any>,type:string):boolean
 ...
 * false otherwise.
 */
declare function is_resource(value:any):boolean
 ...
 * false otherwise.
 */
declare function is_bool(value:any):boolean
 ...
 * false otherwise.
 */
declare function is_long(value:any):boolean
 ...
 * false otherwise.
 */
declare function is_float(value:any):boolean
 ...
 * false otherwise.
 */
declare function is_int(value:any):boolean
 ...
 * false otherwise.
 */
declare function is_integer(value:any):boolean
 ...
 * false otherwise.
 */
declare function is_double(value:any):boolean
 ...
 * false otherwise.
 */
declare function is_real(vars:any):boolean
 ...
 */
declare function is_numeric(value:any):boolean
 ...
 * false otherwise.
 */
declare function is_string(value:any):boolean
 ...
 * otherwise.
 */
declare function is_scalar(value:any):boolean
 ...
 * otherwise.
 */
declare function is_callable(value:any,syntax_only?:boolean, callbackName?:RMD<string>):boolean
 ...
 * @since 7.3
 */
declare function is_countable(value:any):boolean
 ...
 * </p>
 */
declare function pclose(handle:any): int
 ...
 */
declare function popen(command:string,mode:string)
 ...
 */
declare function readfile(filename:string,use_include_path:boolean = false, context:Resource=null): int|false
 ...
 * @return bool true on success or false on failure.
 */
declare function rewind(stream:any):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function rmdir(directory:string,context:Resource=null):boolean
 ...
 */
declare function umask(mask?:int): int
 ...
 * @return bool true on success or false on failure.
 */
declare function fclose(stream:any):boolean
 ...
 */
declare function feof(stream:any):boolean
 ...
 */
declare function fgetc(stream:any): string|false
 ...
 * If an error occurs, returns false.
 */
declare function fgets(stream:any,length?:int): string|false
 ...
 * @removed 8.0
 */
declare function fgetss(handle:any, length:int = null,allowable_tags:any = null): false|string
 ...
 */
declare function fread(stream:any,length:int): string|false
 ...
 */
declare function fpassthru(stream:any)
 ...
 * @return bool true on success or false on failure.
 */
declare function ftruncate(stream:any,size:int):boolean
 ...
 */
declare function fstat(stream:any): array|false
 ...
 */
declare function fseek(stream:any, offset:int, whence:number = SEEK_SET): int
 ...
 * If an error occurs, returns false.
 */
declare function ftell(stream:any): int|false
 ...
 * @return bool true on success or false on failure.
 */
declare function fflush(stream:any):boolean
 ...
 */
declare function fwrite(stream:any,data:string,length?:int): int|false
 ...
 * Binary-safe file write
 */
declare function fputs(stream:any,data:string,length?:int): int|false
 ...
 * @return bool true on success or false on failure.
 */
declare function mkdir(directory:string, permissions?:number, recursive:boolean = false, context:Resource=null):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function rename(from:string,to:string,context:any):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function copy(from:string,to:string,context:any):boolean
 ...
 * failure.
 */
declare function tempnam(directory:string,prefix:string): string|false
 ...
 * </p>
 */
declare function file(filename:string,flags:int,context:any): array|false
 ...
 */
declare function file_get_contents(filename:string, use_include_path:boolean = false, context:Resource=null, offset:int = 0, length:int=null): string|false
 ...
 * file_put_contents(filename:any, implode('',array:any)).
 * </p>
 * @param int $flags [optional] <p>
 ...
 * false on failure.
 */
declare function file_put_contents(filename:string,data:any,flags:int = 0,context:Resource=null): int|false
