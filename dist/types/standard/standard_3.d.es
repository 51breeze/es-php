 ...
 */
declare function getlastmod(): int|false
 ...
 * binary.
 */
declare function base64_decode(string:string,strict:boolean = false): string|false
 ...
 */
declare function convert_uuencode(string:string): string
 ...
 */
declare function convert_uudecode(string:string): string|false
 ...
 */
declare function abs(num:int|float): int|float
 ...
 */
declare function ceil(num:int|float)
/**
 ...
 * usually bigger than that of integer.
 */
declare function floor(num:int|float)
 ...
 */
declare function round(num:int|float,precision:int = 0,mode:int = PHP_ROUND_HALF_UP): float
 ...
 */
declare function sin(num:float): float
 ...
 */
declare function cos(num:float): float
 ...
 */
declare function tan(num:float): float
 ...
 */
declare function asin(num:float): float
 ...
 */
declare function acos(num:float): float
 ...
 */
declare function atan(num:float): float
 ...
 */
declare function atanh(num:float): float
 ...
 */
declare function sinh(num:float): float
 ...
 */
declare function cosh(num:float): float
 ...
 */
declare function tanh(num:float): float
 ...
 */
declare function asinh(num:float): float
 ...
 */
declare function acosh(num:float): float
 ...
 */
declare function expm1(num:float): float
 ...
 */
declare function log1p(num:float): float
 ...
 * else false.
 */
declare function is_finite(num:float):boolean
 ...
 * else false.
 */
declare function is_nan(num:float):boolean
 ...
 * @since 7.0
 */
declare function intdiv(num1:int,num2:int): int
 ...
 */
declare function is_infinite(num:float):boolean
 ...
 */
declare function pow(num:any,exponent:any): object|int|float
 ...
 */
declare function exp(num:float): float
 ...
 * natural logarithm.
 */
declare function log(num:float,base:float = M_E): float
 ...
 */
declare function log10(num:float): float
 ...
 */
declare function sqrt(num:float): float
 ...
 */
declare function hypot(x:float,y:float): float
 ...
 */
declare function deg2rad(num:float): float
 ...
 */
declare function rad2deg(num:float): float
 ...
 */
declare function bindec(binary_string:string): int|float
 ...
 */
declare function hexdec(hex_string:string): int|float
 ...
 */
declare function octdec(octal_string:string): int|float
 ...
 */
declare function decbin(num:int): string
 ...
 */
declare function decoct(num:int): string
 ...
 */
declare function dechex(num:int): string
 ...
 */
declare function base_convert(num:string,from_base:int,to_base:int): string
 ...
 */
declare function number_format(num:float , decimals:int = 0 ,decimal_separator:string = '.' ,thousands_separator:string = ','): string
 ...
 * x/y
 */
declare function fmod(num1:float,num2:float): float
 ...
 * @since 8.0
 */
declare function fdiv(num1:float,num2:float): float
 ...
 */
declare function inet_ntop(ip:string): string|false
 ...
 * address
 */
declare function inet_pton(ip:string): string|false
 ...
 * is invalid.
 */
declare function ip2long(ip:string): int|false
 ...
 */
declare function long2ip(ip:int): string|false
 ...
 */
declare function getenv(name?:string,local_only:boolean = false): array|string|false
 ...
 */
declare function putenv(assignment:string):boolean
 ...
 * failure.
 */
declare function getopt(short_options:string,long_options:array,rest_index:RMD<any>): array|false
 ...
 * @since 5.1.3
 */
declare function sys_getloadavg(): array|false
 ...
 * @return string|float
 */
declare function microtime(as_float:boolean = false): string|float
 ...
 */
declare function gettimeofday(as_float:boolean = false): array|float
 ...
 */
declare function getrusage(mode:int): array|false
 ...
 */
declare function uniqid(prefix:string = "",more_entropy:boolean = false): string
 ...
 */
declare function quoted_printable_decode(string:string): string
 ...
 */
declare function quoted_printable_encode(string:string): string
 ...
 */
declare function set_time_limit(seconds:int):boolean
 ...
 */
declare function get_cfg_var(option:string): array|string|false
 ...
 * @removed 7.0
 */
declare function magic_quotes_runtime(new_setting:boolean)
 ...
 * @removed 7.0
 */
declare function set_magic_quotes_runtime(new_setting:boolean):boolean
 ...
 * @removed 8.0
 */
declare function get_magic_quotes_gpc(): int
 ...
 */
declare function get_magic_quotes_runtime(): int
 ...
 * @removed 5.4
 */
declare function import_request_variables(types:string,prefix:any = null):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function error_log(message:string,message_type:int,destination?:string,additional_headers?:string):boolean
