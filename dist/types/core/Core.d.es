 ...
 * function.
 */
declare function func_num_args(): int
 ...
 */
declare function func_get_arg(position:int):any
 ...
 */
declare function func_get_args(): array
 ...
 */
declare function strlen(string:string): int
 ...
 * equal.
 */
declare function strcmp(string1:string,string2:string): int
 ...
 * equal.
 */
declare function strncmp(string1:string,string2:string,length:int): int
 ...
 * equal.
 */
declare function strcasecmp(string1:string,string2:string): int
 ...
 */
declare function strncasecmp(string1:string,string2:string,length:int): int
 ...
 * @since 8.0
 */
declare function str_starts_with(haystack:string,needle:string) : boolean
 ...
 * @since 8.0
 */
declare function str_ends_with(haystack:string,needle:string) : boolean
 ...
 * @since 8.0
 */
declare function str_contains(haystack:string,needle:string) : boolean
 ...
 * @removed 8.0
 */
declare function each(array:RMD<any>): array
 ...
 * given.
 */
declare function error_reporting(error_level?:int): int
 ...
 * </p>
 * @param null|array|boolean|int|float|string $value <p>
 ...
 */
declare function define(constant_name:string,value:any,case_insensitive:boolean = false):boolean
 ...
 */
declare function defined(constant_name:string):boolean
 ...
 */
declare function get_class(object:object): string
 ...
 */
declare function get_parent_class(object_or_class:object|string): string|false
 ...
 * otherwise.
 */
declare function method_exists(object_or_class:any,method:string):boolean
 ...
 */
declare function property_exists(object_or_class:any,property:string):boolean
 ...
 * @since 5.4
 */
declare function trait_exists(trait:string,autoload:boolean = true):boolean
 ...
 * false otherwise.
 */
declare function class_exists(className:string,autoload:boolean = true):boolean
 ...
 * @since 5.0.2
 */
declare function interface_exists(interfaceName:string,autoload:boolean = true):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function class_alias(className:string,alias:string,autoload:boolean = true):boolean
 ...
 * </p>
 */
declare function get_included_files(): array
 ...
 * @return string[]
 */
declare function get_required_files(): array
 ...
 */
declare function is_subclass_of(object_or_class:any,className:string,allow_string:boolean = true):boolean
 ...
 */
declare function is_a(object_or_class:any,className:string,allow_string:boolean = false):boolean
 ...
 * varname => value.
 */
declare function get_class_vars(className:string): array
 ...
 */
declare function get_object_vars(object:object): array
 ...
 */
declare function get_class_methods(object_or_class:object|string): array
 ...
 */
declare function trigger_error(message:string,error_level:int = E_USER_NOTICE):boolean
 ...
 * specified, true otherwise.
 */
declare function user_error(message:string,error_level:int = E_USER_NOTICE):boolean
 ...
 * and the method name.
 */
declare function set_error_handler(callback?:(...args)=>void,error_levels?:int)
 ...
 */
declare function restore_error_handler():boolean
 ...
 */
declare function set_exception_handler(callback:(...args)=>void):Function|null
 ...
 * @return bool This function always returns true.
 */
declare function restore_exception_handler():boolean
 ...
 * </p>
 */
declare function get_declared_classes(): array
 ...
 * script.
 */
declare function get_declared_interfaces(): array
 ...
 * @since 5.4
 */
declare function get_declared_traits(): array
 ...
 * below).
 */
declare function get_defined_functions(exclude_disabled:boolean = true): array
 ...
 */
declare function get_defined_vars(): array
 ...
 * @removed 8.0
 */
declare function create_function(args:string,code:string): false|string
 ...
 * Unknown.
 */
declare function get_resource_type(resource:any): string
 ...
 */
declare function get_loaded_extensions(zend_extensions:boolean = false): string[]
 ...
 */
declare function extension_loaded(extension:string):boolean
 ...
 */
declare function get_extension_funcs(extension:string): string[]|false
 ...
 * @return array
 */
declare function get_defined_constants(categorize:boolean = false): array
 ...
 * </table>
 */
declare function debug_backtrace(options:int = DEBUG_BACKTRACE_PROVIDE_OBJECT,limit:int = 0): array
 ...
 * @return void
 */
declare function debug_print_backtrace(options:int = 0,limit:int = 0): void
 ...
 */
declare function gc_collect_cycles(): int
 ...
 */
declare function gc_enabled():boolean
 ...
 * @return void
 */
declare function gc_enable(): void
 ...
 * @return void
 */
declare function gc_disable(): void
 ...
 * @since 7.3
 */
declare function gc_status(): number[]
 ...
 * @since 7.0
 */
declare function gc_mem_caches(): int
 ...
 * @since 7.0
 */
declare function get_resources(type?:string): Resource[]
