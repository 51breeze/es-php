 ...
 */
declare interface PHPIterator<T=any> extends Traversable {
    /**
 ...
 * @since 7.0
 */
declare interface Throwable extends Stringable
{
    /**
     * Gets the message
...
declare class Exception implements Throwable {
     ...
     */
    constructor(message:any = "",code:any = 0,previous:Throwable = null)
    /**
 ...
 * @since 7.0
 */
declare class Error implements Throwable {
    /** The error message */
    protected message;
    /** The error code */
    protected code;
 ...
 * @since 7.0
 */
declare class ParseError extends CompileError{}
 ...
 */
declare class ArgumentCountError extends TypeError{}
 ...
 * @since 7.0
 */
declare class DivisionByZeroError extends ArithmeticError{}
...
declare class ErrorException extends Exception {
     ...
     */
     constructor(message:any = "",code:any = 0,severity:any = 1,filename:any = __FILE__,line:any = __LINE__,previous:any = null)
    /**
     * Gets the exception severity
     * @link https://php.net/manual/en/errorexception.getseverity.php
     * @return int the severity level of the exception.
     */
    final getSeverity():number
}
...
declare final class Closure {
     ...
     */
    bindTo(newThis?:object,newScope:object|string|null = 'static'):Closure|false
    /**
     ...
     * @return Closure|false Returns the newly created Closure object or FALSE on failure
     */
    static bind(closure:Closure,newThis?:object,newScope:object|string|null = 'static')
    /**
     ...
     * @since 7.0
     */
    call(newThis:object, ...args:any[]):any
    /**
     * @param callable $callback
     * @return Closure
     * @since 7.1
     */
    static fromCallable (callback:(...args)=>void):Closure
}
...
declare class WeakReference {
     ...
     * @since 7.4
     */
    static create(referent:any):WeakReference
    /**
 ...
 * @since 8.0
 */
declare final class WeakMap implements ArrayAccess, Countable, IteratorAggregate {
    /**
     ...
     * @return void
     */
    offsetSet(object:any,value:any):void
    /**
 ...
 * @since 8.0
 */
declare class PhpToken implements Stringable {
    /**
     ...
     */
    constructor(id:int,text:string,line:int = -1,pos:int = -1)
    /**
     ...
     * @return static[]
     */
    static tokenize(code:string,flags:int = 0):PhpToken[]
    /**
