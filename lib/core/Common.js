...
import {createUniqueHashId, parseUrlAnnotation, parseReadfileAnnotation, getSourceAnnotations, annotationIndexers} from "@easescript/transform/lib/core/Common";
                ...
                if(valueStack.isIdentifier || valueStack.isMemberExpression){
                    ...
                    if(desc){
                        if(Utils.isTypeModule(desc)){
                            type = ctx.getModuleNamespace(desc, desc.id)
