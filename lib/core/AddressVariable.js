class AddressVariable {
    ...
    static REFS_NAME = '__ARD';
    static REFS_INDEX = '__ARI';
    ...
    createName(description){
        ...
        if( !this.refs.has( description ) ){
            const name = this.ctx.getLocalRefName(description, AddressVariable.REFS_NAME );
    ...
    createIndexName(description){
        ...
        if( this.indexName === null ){
            const name = this.ctx.getLocalRefName(description, AddressVariable.REFS_INDEX );
            this.indexName = name;
        }
