 ...
 */
declare function fsockopen(hostname:string,port?:int,error_code?:RMD<any>,error_message?:RMD<any>,timeout?:float)
 ...
 */
declare function pfsockopen(hostname:string,port?:int,error_code?:RMD<any>,error_message?:RMD<any>,timeout?:float)
 ...
 */
declare function pack(format:string, ...values:any[])
 ...
 */
declare function unpack(format:string,string:string,offset:int = 0): array|false
 ...
 */
declare function get_browser(user_agent?:string,return_array:boolean = false): object|array|false
 ...
 */
declare function crypt(string:any):string|null
 ...
 */
declare function crypt(string:string,salt:string): string
 ...
 */
declare function opendir(directory:string,context:any)
 ...
 * @return void
 */
declare function closedir(dir_handle:any): void
 ...
 */
declare function chdir(directory:string):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function chroot(directory:string):boolean
 ...
 * </p>
 */
declare function getcwd(): string|false
 ...
 * @return void
 */
declare function rewinddir(dir_handle:any): void
 ...
 */
declare function readdir(dir_handle:any): string|false
 ...
 */
declare function dir(directory:string,context:any): Directory|false
 ...
 * @see dir()
 */
declare function getdir(directory:string,context:any = null): Directory|false
 ...
 */
declare function scandir(directory:string,sorting_order:int,context:any): array|false
 ...
 * error.</p>
 */
declare function glob(pattern:string,flags:int): array|false
 ...
 */
declare function fileatime(filename:string): int|false
 ...
 * The time is returned as a Unix timestamp.
 */
declare function filectime(filename:string): int|false
 ...
 */
declare function filegroup(filename:string): int|false
 ...
 */
declare function fileinode(filename:string): int|false
 ...
 */
declare function filemtime(filename:string): int|false
 ...
 */
declare function fileowner(filename:string): int|false
 ...
 */
declare function fileperms(filename:string): int|false
 ...
 */
declare function filesize(filename:string): int|false
 ...
 */
declare function filetype(filename:string): string|false
 ...
 * writable.
 */
declare function is_writable(filename:string):boolean
 ...
 * writable.
 */
declare function is_writeable(filename:string):boolean
 ...
 */
declare function is_readable(filename:string):boolean
 ...
 * error.
 */
declare function is_executable(filename:string):boolean
 ...
 * otherwise.
 */
declare function is_file(filename:string):boolean
 ...
 * otherwise.
 */
declare function is_dir(filename:string):boolean
 ...
 * otherwise.
 */
declare function is_link(filename:string):boolean
 ...
 */
declare function stat(filename:string): array|false
 ...
 */
declare function lstat(filename:string): array|false
 ...
 * @return bool true on success or false on failure.
 */
declare function chown(filename:string,user:string|int):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function chgrp(filename:string,group:string|int):boolean
 ...
 * @since 5.1.2
 */
declare function lchown(filename:string,user:string|int):boolean
 ...
 * @since 5.1.2
 */
declare function lchgrp(filename:string,group:string|int):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function chmod(filename:string,permissions:int):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function touch(filename:string,mtime?:int,atime?:int):boolean
 ...
 * @return void
 */
declare function clearstatcache(clear_realpath_cache?:boolean,filename?:string): void
 ...
 * or false on failure.
 */
declare function disk_total_space(directory:string): float|false
 ...
 * or false on failure.
 */
declare function disk_free_space(directory:string): float|false
 ...
 * @return float|false
 */
declare function diskfreespace(directory:string): float|false
 ...
 * </p>
 */
declare function mail(to:string,subject:string,message:string,additional_headers:array|string,additional_params:string):boolean
 ...
 * @removed 8.0
 */
declare function ezmlm_hash(addr:string): int
 ...
 * @return bool true on success or false on failure.
 */
declare function openlog(prefix:string,flags:int,facility:int):boolean
