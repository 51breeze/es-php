 ...
 * @return void
 */
declare function __halt_compiler():void;
 ...
 * @return void
 */
declare const __COMPILER_HALT_OFFSET__=0;
 ...
 * @since 5.4
 */
declare function hex2bin(string:string): string|false;

/**
 * Get or Set the HTTP response code
 * @param int $response_code [optional] The optional response_code will set the response code.
 * @return int|boolean The current response code. By default the return value is int(200).
 */
declare function http_response_code(response_code:int): int|boolean
