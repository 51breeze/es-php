 ...
 * @since 5.6
 */
declare const ARRAY_FILTER_USE_BOTH= 1;

/**
 * @since 5.6
 */
declare const ARRAY_FILTER_USE_KEY= 2;
 ...
 */
declare function array_replace(array:array, ...replacements:array[]): array
 ...
 */
declare function array_replace_recursive(array:array, ...replacements:array[]): array
 ...
 */
declare function array_keys(array:array,filter_value:any,strict:boolean = false): array
 ...
 * @meta
 */
declare function array_values(array:array): array
 ...
 */
declare function array_count_values(array:array): array
 ...
 * @since 5.5
 */
declare function array_column(array:array,column_key:string|int|null, index_key:string|int|null = null): array
 ...
 * @meta
 */
declare function array_reverse(array:array,preserve_keys:boolean = false): array
 ...
 * The callback function. Signature is <pre>callback (carry:any ,item:any ) : mixed</pre>
 ...
 * <p>
 * Example use:
 * <blockquote><pre>array_reduce(['2', '3', '4'], function(ax:any,dx:any) { return $ax . ", {$dx}"; }, '1')  // Returns '1, 2, 3, 4'</pre></blockquote>
 * <blockquote><pre>array_reduce(['2', '3', '4'], function(ax:any,dx:any) { return $ax + (int)$dx; }, 1)  // Returns 10</pre></blockquote>
 * <br/>
 * </p>
 * @meta
 */
declare function array_reduce(array:array,callback:GeneralCallback<any,any>,initial:any=[]):any
 ...
 */
declare function array_pad(array:array,length:int,value:any): array
 ...
 */
declare function array_flip(array:array): array
 ...
 * @meta
 */
declare function array_change_key_case(array:array,cases:int): array
 ...
 */
declare function array_rand(array:array,num:int = 1): array|string|int
 ...
 * @meta
 */
declare function array_unique(array:array,flags:int = SORT_STRING): array
 ...
 * @meta
 */
declare function array_intersect(array:array, ...arrays:array[]): array
 ...
 * @meta
 */
declare function array_intersect_key(array1:array,array2:array, ...args:array[]): array
 ...
 * @meta
 */
declare function array_intersect_ukey(array1:array,array2:array,key_compare_func?:GeneralCallback<any,number>): array
 ...
 * @meta
 */
declare function array_uintersect(array1:any[],array2:any[],data_compare_func?:GeneralCallback<any,number>): array
 ...
 * @meta
 */
declare function array_intersect_assoc(array1:any[],array2:any[],_:array = null): array
 ...
 * @meta
 */
declare function array_uintersect_assoc(array1:any[],array2:any[],data_compare_func?:GeneralCallback<any,number>): array
 ...
 * @meta
 */
declare function array_intersect_uassoc(array1:any[],array2:any[],key_compare_func?:GeneralCallback<any,number>): array
 ...
 * @meta
 */
declare function array_uintersect_uassoc(array1:any[],array2:any[],data_compare_func?:GeneralCallback<any,number>,key_compare_func?:GeneralCallback<any,number>): array
 ...
 * @meta
 */
declare function array_diff(array:any[], ...excludes:array[]): array
 ...
 * @meta
 */
declare function array_diff_key(array1:any[],array2:any[], ...args:array[]): array
 ...
 * @meta
 */
declare function array_diff_ukey(array1:any[],array2:any[],key_compare_func?:GeneralCallback<any,number>): array
 ...
 * @meta
 */
declare function array_udiff(array1:array,array2:array,data_compare_func?:GeneralCallback<any,number>): array
 ...
 * @meta
 */
declare function array_diff_assoc(array1:array,array2:array, ...args:array[]): array
 ...
 * @meta
 */
declare function array_udiff_assoc(array1:array,array2:array,data_compare_func?:GeneralCallback<any,number>): array
 ...
 * @meta
 */
declare function array_diff_uassoc(array1:any[],array2:any[],key_compare_func?:GeneralCallback<any,number>): array
 ...
 * @meta
 */
declare function array_udiff_uassoc(array1:any[],array2:any[],data_compare_func?:GeneralCallback<any,number>,key_compare_func?:GeneralCallback<any,number>): array
 ...
 */
declare function array_sum(array:array): int|float
 ...
 */
declare function array_product(array:array): int|float
 ...
 * @meta
 */
declare function array_filter(array:array,callback?:GeneralCallback<any,boolean>,mode:int = 0): array
 ...
 * @meta
 */
declare function array_map(callback:GeneralCallback<any,any>, array:array, ...arrays:array[]): array
 ...
 */
declare function array_chunk(array:array,length:int,preserve_keys:boolean = false): array
 ...
 * @meta
 */
declare function array_combine(keys:array,values:array)
 ...
 */
declare function array_key_exists(key:any,array:any):boolean
 ...
 * @since 7.3
 */
declare function array_key_first(array:array): string|int|null
 ...
 * @since 7.3
 */
declare function array_key_last(array:array): string|int|null
 ...
 * @return mixed
 */
declare function pos(array:object|array):any
 ...
 * @return int
 */
declare function sizeof(value:Countable|array,mode:number = COUNT_NORMAL): int
 ...
 * @return bool true on success or false on failure.
 */
declare function key_exists(key:any,array:array):boolean
 ...
 */
declare function assert(assertion:any,description:any = ''):boolean
 ...
 */
declare function assert_options(option:int,value:any): object|array|string|int|null
 ...
 * </p>
 * @return int|boolean By default, version_compare returns
 ...
 */
declare function version_compare(version1:string,version2:string,operator?:string): int|boolean
 ...
 * -1 is returned.
 */
declare function ftok(filename:string,project_id:string): int
 ...
 */
declare function str_rot13(string:string): string
 ...
 * available.
 */
declare function stream_get_filters(): array
 ...
 * @since 7.2
 */
declare function stream_isatty(stream:any):boolean
 ...
 * </p>
 */
declare function stream_filter_register(filter_name:string,className:string):boolean
 ...
 * @return object|null
 */
declare function stream_bucket_make_writeable(brigade:any):object|null
 ...
 * @return void
 */
declare function stream_bucket_prepend(brigade:any,bucket:object): void
 ...
 * @return void
 */
declare function stream_bucket_append(brigade:any,bucket:object): void
 ...
 * @return object
 */
declare function stream_bucket_new(stream:any,buffer:string): object
 ...
 * @return bool true on success or false on failure.
 */
declare function output_add_rewrite_var(name:string,value:string):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function output_reset_rewrite_vars():boolean
 ...
 * @since 5.3.2
 */
declare function realpath_cache_get(): array
 ...
 * @since 5.3.2
 */
declare function realpath_cache_size(): int
 ...
 * @since 7.4
 */
declare function get_mangled_object_vars(object:object): array
 ...
 * @since 8.0
 */
declare function get_debug_type(value:any): string
 ...
 * @since 8.0
 */
declare function get_resource_id(resource:any): int
