 ...
 * @since 5.4
 */
declare function stream_set_chunk_size(stream:any ,size:int)
 ...
 * print_r(expression:any, true) or
 * highlight_file(filename:any, true) from a callback
 * function.
 * </p>
 * <p>
 ...
 * @return bool true on success or false on failure.
 */
declare function ob_start(callback:any,chunk_size:int,flags?:number):boolean
 ...
 * @param int|boolean $enable [optional] <p>
 * 1|<b>TRUE</b> to turn implicit flushing on, 0|<b>FALSE</b> turns it off.
 * <br><br>default: 1|<b>TRUE</b>
 * </p>
 * @return void
 */
declare function ob_implicit_flush(enable:any = true): void
 ...
 * @return bool true on success or false on failure.
 */
declare function usort(array:RMD<array>,callback:GeneralCallback<any,any>):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function uasort(array:RMD<array>,callback:GeneralCallback<any,any>):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function uksort(array:RMD<array>,callback:GeneralCallback<any,number>):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function array_walk(array:RMD<object|array>,callback:GeneralCallback<any,any>,arg:any):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function array_walk_recursive(array:RMD<object|array>,callback:GeneralCallback<any,any>,arg:any):boolean
 ...
 * </p>
 */
declare function count(value:Countable|array,mode:number = COUNT_NORMAL): int
 ...
 * parameter values.
 */
declare function min(value:any, ...values:any[]):any
 ...
 */
declare function max(value:any, ...values:any[]):any
 ...
 * false otherwise.
 */
declare function in_array(needle:any,haystack:array,strict:boolean = false):boolean
 ...
 */
declare function array_search(needle:any,haystack:array,strict:boolean = false): string|int|false
 ...
 * table.
 */
declare function extract(array:RMD<array>,flags?:int,prefix?:string): int
 ...
 */
declare function compact(var_name:any, ...var_names:any[]): array
 ...
 * end, inclusive.
 */
declare function range(start:any,end:any,step:int|float = 1): array
 ...
 * @return bool true on success or false on failure.
 */
declare function array_multisort(array:RMD<array>, ...rest:RMD<array>[]):boolean
 ...
 */
declare function array_push(array:RMD<array>, ...values:any[]): int
 ...
 * @meta
 */
declare function array_pop(array:RMD<array>):any
 ...
 * @meta
 */
declare function array_shift(array:RMD<array>):any
 ...
 * @return int the number of elements in the array.
 */
declare function array_unshift(array:RMD<array>, ...values:any[]): int
 ...
 */
declare function array_splice(array:RMD<array>,offset:int,length?:int,replacement:any): array
 ...
 * @meta
 */
declare function array_slice(array:array,offset:int,length?:int,preserve_keys:boolean = false): array
