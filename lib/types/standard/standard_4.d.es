 ...
 * yet.
 */
declare function error_get_last():array|null
 ...
 * array(classname:any,methodname:any) to this parameter.
 * Additionally class methods of an object instance may be called by passing
 * array(objectinstance:any,methodname:any) to this parameter.
 * </p>
 ...
 */
declare function call_user_func(callback:(...args)=>void, ...args:any[]):any
 ...
 * @return mixed|false the function result, or false on error.
 */
declare function call_user_func_array(callback:(...args)=>void,args:array):any
 ...
 * @see call_user_func()
 */
declare function call_user_method(method_name:string,obj:RMD<object>, ...parameter:any[]):any
 ...
 * @see call_user_func()
 */
declare function call_user_method_array(method_name:string,obj:RMD<object>,params:array):any
 ...
 * @return mixed|false the function result, or false on error.
 */
declare function forward_static_call(callback:(...args)=>void, ...args:any[]):any
 ...
 * @return mixed|false the function result, or false on error.
 */
declare function forward_static_call_array(callback:(...args)=>void,args:array):any
 ...
 */
declare function unserialize(data:string,options:array = []):any
 ...
 * @return void
 */
declare function var_dump(value:any, ...values:any[]): void
 ...
 * return null.
 */
declare function var_export(value:any, rets:boolean = false):string|null
 ...
 * @return void
 */
declare function debug_zval_dump(value:any, ...values:any[]): void
 ...
 * </p>
 * @return string|boolean If given a string, integer or float,
 * the value itself will be printed. If given an array, values
 * will be presented in a format that shows keys and elements. Similar
 * notation is used for objects.
 */
declare function print_r(value:any, rets:boolean = false): string|boolean
 ...
 */
declare function memory_get_usage(real_usage:boolean = false): int
 ...
 */
declare function memory_get_peak_usage(real_usage:boolean = false): int
 ...
 * @return bool|null
 */
declare function register_shutdown_function(callback:(...args)=>void, ...args:any[]):boolean|null
 ...
 */
declare function register_tick_function(callback:(...args)=>void, ...args:any[]):boolean
 ...
 * @return void
 */
declare function unregister_tick_function(callback:(...args)=>void): void
 ...
 * highlighted code.
 * </p>
 * @return string|boolean If return is set to true, returns the highlighted
 * code as a string instead of printing it out. Otherwise, it will return
 * true on success, false on failure.
 */
declare function highlight_file(filename:string,rets:boolean = false): string|boolean
 ...
 */
declare function show_source(filename:string,rets:boolean = false): string|boolean
 ...
 * true on success, false on failure.
 */
declare function highlight_string(string:string,rets:boolean = false): string|boolean
 ...
 */
declare function hrtime(as_number:boolean = false): array|int|float|false
 ...
 */
declare function ini_get(option:string): string|false
 ...
 * </p>
 */
declare function ini_get_all(extension?:string,details:boolean = true): array|false
 ...
 */
declare function ini_set(option:string,value:string): string|false
 ...
 * @return string|false
 */
declare function ini_alter(option:string,value:string): string|false
 ...
 * @return void
 */
declare function ini_restore(option:string): void
 ...
 */
declare function get_include_path(): string|false
 ...
 */
declare function set_include_path(include_path:string): string|false
 ...
 */
declare function setcookie(name:string,value:any = "",expires_or_options:any = 0,path:any = "",domain:any = "",secure:any = false,httponly:any = false):boolean
 ...
 * @since 7.3
 */
declare function setcookie(name:string,value:any = '',options:array = []):boolean
 ...
 * @return bool true on success or false on failure.
 */
declare function setrawcookie(name:string,value:any = '',expires_or_options:any = 0,path:any = "",domain:any = "",secure:any = false,httponly:any = false):boolean
 ...
 *                        This does not indicate whether the user accepted the cookie.
 */
declare function setrawcookie(name:string,value:any = '',options:array = []):boolean
 ...
 * @return void
 */
declare function header(header:string,replace?:boolean,response_code?:number): void
 ...
 * @return void
 */
declare function header_remove(name?:string): void
 ...
 */
declare function headers_sent(filename:RMD<any>,line:RMD<any>):boolean
 ...
 */
declare function headers_list(): array
 ...
 */
declare function apache_request_headers(): false|array
 ...
 * @return array|false An associative array of all the HTTP headers in the current request, or <b>FALSE</b> on failure.
 */
declare function getallheaders(): false|array
 ...
 */
declare function connection_aborted(): int
 ...
 * status.
 */
declare function connection_status(): int
 ...
 */
declare function ignore_user_abort(enable?:boolean): int
 ...
 */
declare function parse_ini_file(filename:string,process_sections:boolean = false,scanner_mode:int = INI_SCANNER_NORMAL): array|false
 ...
 * and false on failure.
 */
declare function parse_ini_string(ini_string:string,process_sections:boolean = false,scanner_mode:int = INI_SCANNER_NORMAL): array|false
 ...
 * @return bool true on success or false on failure.
 */
declare function is_uploaded_file(filename:string):boolean
 ...
 */
declare function move_uploaded_file(from:string,to:string):boolean

/**
 * @return array|false
 * @since 7.3
 */
declare function net_get_interfaces(): array|false
 ...
 * on failure.
 */
declare function gethostbyaddr(ip:string): string|false
 ...
 * hostname on failure.
 */
declare function gethostbyname(hostname:string): string
 ...
 */
declare function gethostbynamel(hostname:string): array|false
 ...
 * returned.
 */
declare function gethostname(): string|false
 ...
 */
declare function dns_check_record(hostname:string,type:string = 'MX'):boolean
 ...
 */
declare function checkdnsrr(hostname:string,type:string = 'MX'):boolean
 ...
 * @return bool
 */
declare function dns_get_mx(hostname:string,hosts:RMD<any>,weights:RMD<any>):boolean
 ...
 * were found or if an error occurred.
 */
declare function getmxrr(hostname:string,hosts:RMD<any>,weights:RMD<any>):boolean
 ...
 * </table>
 */
declare function dns_get_record(hostname:string,type:int = DNS_ANY,authoritative_name_servers:RMD<any>=null,additional_records:RMD<any>=null,raw:boolean = false): array|false
