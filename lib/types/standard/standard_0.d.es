 ...
 */
declare function bin2hex(string:string): string
 ...
 * to sleep.
 */
declare function sleep(seconds:int)
 ...
 * @return void
 */
declare function usleep(microseconds:int): void
 ...
 * </p>
 */
declare function time_nanosleep(seconds:int,nanoseconds:int): array|boolean
 ...
 * </p>
 */
declare function strptime(timestamp:string,format:string): array|false
 ...
 */
declare function wordwrap(string:string,width:int = 75,newLine:string = "\n",cut_long_words:boolean = false): string
 ...
 */
declare function htmlspecialchars(string:string,flags:int, encoding?:string,double_encode:boolean = true): string
 ...
 */
declare function htmlentities(string:string, flags?:int, encoding?:string, double_encode:boolean = true): string
 ...
 */
declare function html_entity_decode(string:string,flags?:int,encoding?:string): string
 ...
 * @return string the decoded string.
 */
declare function htmlspecialchars_decode(string:string,flags?:int): string
 ...
 */
declare function get_html_translation_table(table:int,flags:int = ENT_COMPAT,encoding:string = "UTF-8"): array
 ...
 */
declare function sha1(string:string,binary:boolean = false): string
 ...
 */
declare function sha1_file(filename:string,binary:boolean = false): string|false
 ...
 */
declare function md5(string:string,binary:boolean = false): string
 ...
 * @return string|false a string on success, false otherwise.
 */
declare function md5_file(filename:string,binary:boolean = false): string|false
 ...
 */
declare function crc32(string:string): int
 ...
 */
declare function iptcparse(iptc_block:string): array|false
 ...
 * </p>
 * @return string|boolean If success and spool flag is lower than 2 then the JPEG will not be
 * returned as a string, false on errors.
 */
declare function iptcembed(iptc_data:string,filename:string,spool:int): string|boolean
 ...
 * </p>
 */
declare function getimagesize(filename:string,image_info:RMD<any>): array|false
 ...
 * </table>
 */
declare function image_type_to_mime_type(image_type:int): string
 ...
 */
declare function image_type_to_extension(image_type:int,include_dot:any = true): string|false
 ...
 * @return bool true on success or false on failure.
 */
declare function phpinfo(flags:int = INFO_ALL):boolean
 ...
 */
declare function phpversion(extension?:string): string|false
 ...
 * @return bool true on success or false on failure.
 */
declare function phpcredits(flags:int = CREDITS_ALL):boolean
 ...
 * @removed 5.5
 */
declare function php_real_logo_guid()

/**
 * @removed 5.5
 */
declare function php_egg_logo_guid()
 ...
 * </p>
 */
declare function php_sapi_name(): string|false
 ...
 */
declare function php_uname(mode:string = 'a'): string
 ...
 */
declare function php_ini_scanned_files(): string|false
 ...
 * @since 5.2.4
 */
declare function php_ini_loaded_file(): string|false
 ...
 */
declare function strnatcmp(string1:string,string2:string): int
 ...
 * str2, and 0 if they are equal.
 */
declare function strnatcasecmp(string1:string,string2:string): int
 ...
 */
declare function substr_count(haystack:string,needle:string,offset:int,length?:int): int
 ...
 */
declare function strspn(string:string,characters:string,offset:int,length?:int): int
 ...
 */
declare function strcspn(string:string,characters:string,offset:int,length?:int): int
 ...
 */
declare function strtok(string:string,token?:string): string|false
