 ...
 */
declare const PASSWORD_DEFAULT= "2y";
 ...
 * </ul>
 */
declare const PASSWORD_BCRYPT_DEFAULT_COST= 10;
 ...
 * </ul>
 */
declare const PASSWORD_BCRYPT= '2y';
 ...
 * @since 7.2
 */
declare const PASSWORD_ARGON2I= 'argon2i';
 ...
 * @since 7.3
 */
declare const PASSWORD_ARGON2ID= 'argon2id';
 ...
 * @since 7.2
 */
declare const PASSWORD_ARGON2_DEFAULT_MEMORY_COST= 65536;
 ...
 * @since 7.2
 */
declare const PASSWORD_ARGON2_DEFAULT_TIME_COST= 4;
 ...
 * @since 7.2
 */
declare const PASSWORD_ARGON2_DEFAULT_THREADS= 1;

/**
 * @since 7.4
 */
declare const PASSWORD_ARGON2_PROVIDER= 'standard';
 ...
 * @since 5.5
 */
declare function password_get_info(hash:string):array|null
 ...
 * @since 5.5
 */
declare function password_hash(password:string,algo:string|int|null,options:array = [])
 ...
 * @since 5.5
 */
declare function password_needs_rehash(hash:string,algo:string|int|null,options:array = []):boolean
 ...
 * @since 5.5
 */
declare function password_verify(password:string,hash:string):boolean
 ...
 * @since 7.4
 */
declare function password_algos(): array
// End of password v.
