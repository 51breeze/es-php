...
declare class JsonIncrementalParser{

	static const JSON_PARSER_SUCCESS = 0;
	static const JSON_PARSER_CONTINUE = 1;

	/**
	 * @param int $depth [optional]
	 * @param int $options [optional]
	 */
	constructor(depth?:number, options?:number)
 ...
 */
declare function json_encode(value, flags?:number=0, depth?:number = 512): string|false
 ...
 */
declare  function json_decode(json:string,associative = false, depth:number = 512, flags:number = 0):any;
 ...
 * </table>
 */
declare function json_last_error (): int
 ...
 * @since 5.5
 */
declare function json_last_error_msg (): string
 ...
 */
declare const JSON_HEX_TAG= 1;

/**
 * All &s are converted to \u0026.
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_HEX_AMP= 2;

/**
 * All ' are converted to \u0027.
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_HEX_APOS= 4;

/**
 * All " are converted to \u0022.
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_HEX_QUOT= 8;
 ...
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_FORCE_OBJECT= 16;
 ...
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_NUMERIC_CHECK= 32;
 ...
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_UNESCAPED_SLASHES= 64;
 ...
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_PRETTY_PRINT= 128;
 ...
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_UNESCAPED_UNICODE= 256;
declare const JSON_PARTIAL_OUTPUT_ON_ERROR= 512;

/**
 * Occurs with underflow or with the modes mismatch.
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_ERROR_STATE_MISMATCH= 2;

/**
 * Control character error, possibly incorrectly encoded.
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_ERROR_CTRL_CHAR= 3;
 ...
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_ERROR_UTF8= 5;
 ...
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_ERROR_RECURSION= 6;
 ...
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_ERROR_INF_OR_NAN= 7;
 ...
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_ERROR_UNSUPPORTED_TYPE= 8;

/**
 * No error has occurred.
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_ERROR_NONE= 0;

/**
 * The maximum stack depth has been exceeded.
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_ERROR_DEPTH= 1;

/**
 * Syntax error.
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_ERROR_SYNTAX= 4;
 ...
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_OBJECT_AS_ARRAY= 1;
declare const JSON_PARSER_NOTSTRICT= 4;
 ...
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_BIGINT_AS_STRING= 2;
 ...
 * @link https://php.net/manual/en/json.constants.php
 */
declare const JSON_PRESERVE_ZERO_FRACTION= 1024;
 ...
 * @since 7.1
 */
declare const JSON_UNESCAPED_LINE_TERMINATORS= 2048;

/**
 * Ignore invalid UTF-8 characters.
 * @since 7.2
 */
declare const JSON_INVALID_UTF8_IGNORE= 1048576;

/**
 * Convert invalid UTF-8 characters to \0xfffd (Unicode Character 'REPLACEMENT CHARACTER').
 * @since 7.2
 */
declare const JSON_INVALID_UTF8_SUBSTITUTE= 2097152;
 ...
 * @since 7.0
 */
declare const JSON_ERROR_INVALID_PROPERTY_NAME=9;
 ...
 * @since 7.0
 */
declare const JSON_ERROR_UTF16=10;
 ...
 * @since 7.3
 */
declare const JSON_THROW_ON_ERROR= 4194304;
 ...
 */
declare class JsonException extends Exception {}
