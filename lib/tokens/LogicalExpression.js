...
function isBooleanExpression(stack){
     ...
     return stack.parentStack.isIfStatement || 
          ...
          stack.parentStack.isArrowFunctionExpression && stack.parentStack.body !==stack || 
...
export default function(ctx,stack){
     ...
     if( !isBoolean ){ 
          ...
          if( needRefs ){
               ...
               if( createRefs ){
                    refs = ctx.getLocalRefName(stack, AddressVariable.REFS_VALUE, stack);
               ...
               if( isAddress ){
                    ...
                    const assignName = ctx.getLocalRefName(stack, AddressVariable.REFS_INDEX, stack);
